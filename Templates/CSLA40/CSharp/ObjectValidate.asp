...
4.3.1. Check Criteria for DeleteOptions where DataPortal is set and SProc name is empty
4.3.2. Check Criteria for DeleteOptions where DataPortal is not set and SProc name is not empty (WARNINGS)
