...
namespace SelfLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// C07Level1111ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class C07Level1111ReChild : BusinessBase<C07Level1111ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="C07Level1111ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="C07Level1111ReChild"/> object.</returns>
        internal static C07Level1111ReChild NewC07Level1111ReChild()
        {
            return DataPortal.CreateChild<C07Level1111ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="C07Level1111ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="C07Level1111ReChild"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(C06Level111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddC07Level1111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="C07Level1111ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(C06Level111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateC07Level1111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_ID", parent.Level_1_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_Child_Name", ReadProperty(Level_1_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="C07Level1111ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(C06Level111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteC07Level1111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_ID", parent.Level_1_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
