...
namespace SelfLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// C11Level111111ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class C11Level111111ReChild : BusinessBase<C11Level111111ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="C11Level111111ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="C11Level111111ReChild"/> object.</returns>
        internal static C11Level111111ReChild NewC11Level111111ReChild()
        {
            return DataPortal.CreateChild<C11Level111111ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="C11Level111111ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="C11Level111111ReChild"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(C10Level11111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddC11Level111111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="C11Level111111ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(C10Level11111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateC11Level111111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_ID", parent.Level_1_1_1_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_1_Child_Name", ReadProperty(Level_1_1_1_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="C11Level111111ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(C10Level11111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteC11Level111111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_ID", parent.Level_1_1_1_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
