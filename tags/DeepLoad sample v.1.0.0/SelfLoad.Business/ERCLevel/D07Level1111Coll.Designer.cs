...
namespace SelfLoad.Business.ERCLevel
{
    ...
    public partial class D07Level1111Coll : BusinessListBase<D07Level1111Coll, D08Level1111>
    {
        ...
        {
            foreach (var d08Level1111 in this)
            {
        ...
        /// <summary>
        /// Determines whether a <see cref="D08Level1111"/> item is in the collection.
        /// </summary>
        /// <param name="level_1_1_1_1_ID">The Level_1_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the D08Level1111 is a collection item; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="D08Level1111"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="level_1_1_1_1_ID">The Level_1_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the D08Level1111 is a deleted collection item; otherwise, <c>false</c>.</returns>
        public bool ContainsDeleted(int level_1_1_1_1_ID)
        {
            foreach (var d08Level1111 in this.DeletedList)
            {
                if (d08Level1111.Level_1_1_1_1_ID == level_1_1_1_1_ID)
                {
                    return true;
