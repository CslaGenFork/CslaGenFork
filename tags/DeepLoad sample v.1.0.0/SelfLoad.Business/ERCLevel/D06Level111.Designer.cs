...
namespace SelfLoad.Business.ERCLevel
{
    ...
    /// <summary>
    /// D06Level111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class D06Level111 : BusinessBase<D06Level111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<D07Level1111Child> D07Level1111SingleObjectProperty = RegisterProperty<D07Level1111Child>(p => p.D07Level1111SingleObject, "B7 Level1111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<D07Level1111ReChild> D07Level1111ASingleObjectProperty = RegisterProperty<D07Level1111ReChild>(p => p.D07Level1111ASingleObject, "B7 Level1111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<D07Level1111Coll> D07Level1111ObjectsProperty = RegisterProperty<D07Level1111Coll>(p => p.D07Level1111Objects, "B7 Level1111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="D06Level111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="D06Level111"/> object.</returns>
        internal static D06Level111 NewD06Level111()
        {
            return DataPortal.CreateChild<D06Level111>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="D06Level111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            LoadProperty(Level_1_1_1_IDProperty, System.Threading.Interlocked.Decrement(ref _lastID));
            LoadProperty(D07Level1111SingleObjectProperty, DataPortal.CreateChild<D07Level1111Child>());
            LoadProperty(D07Level1111ASingleObjectProperty, DataPortal.CreateChild<D07Level1111ReChild>());
            LoadProperty(D07Level1111ObjectsProperty, DataPortal.CreateChild<D07Level1111Coll>());
        ...
        /// <summary>
        /// Inserts a new <see cref="D06Level111"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(D04Level11 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddD06Level111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="D06Level111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateD06Level111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="D06Level111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteD06Level111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_ID", ReadProperty(Level_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
