...
namespace ParentLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// A06Level111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class A06Level111 : BusinessBase<A06Level111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<A07Level1111Child> A07Level1111SingleObjectProperty = RegisterProperty<A07Level1111Child>(p => p.A07Level1111SingleObject, "A7 Level1111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<A07Level1111ReChild> A07Level1111ASingleObjectProperty = RegisterProperty<A07Level1111ReChild>(p => p.A07Level1111ASingleObject, "A7 Level1111 ASimple Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<A07Level1111Coll> A07Level1111ObjectsProperty = RegisterProperty<A07Level1111Coll>(p => p.A07Level1111Objects, "A7 Level1111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="A06Level111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="A06Level111"/> object.</returns>
        internal static A06Level111 NewA06Level111()
        {
            return DataPortal.CreateChild<A06Level111>();
        }
        ...
        internal static A06Level111 GetA06Level111(SafeDataReader dr)
        {
            ...
            obj.MarkAsChild();
            obj.Fetch(dr);
            obj.LoadProperty(A07Level1111ObjectsProperty, A07Level1111Coll.NewA07Level1111Coll());
            obj.MarkOld();
            return obj;
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="A06Level111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="A06Level111"/> object in the database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Insert(A04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddA06Level111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="A06Level111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateA06Level111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="A06Level111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
