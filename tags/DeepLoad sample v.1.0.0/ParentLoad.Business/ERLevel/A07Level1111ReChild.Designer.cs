...
namespace ParentLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// A07Level1111ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class A07Level1111ReChild : BusinessBase<A07Level1111ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="A07Level1111ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="A07Level1111ReChild"/> object.</returns>
        internal static A07Level1111ReChild NewA07Level1111ReChild()
        {
            return DataPortal.CreateChild<A07Level1111ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="A07Level1111ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="A07Level1111ReChild"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(A06Level111 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddA07Level1111ReChild", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="A07Level1111ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(A06Level111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateA07Level1111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_ID", parent.Level_1_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_Child_Name", ReadProperty(Level_1_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="A07Level1111ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(A06Level111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteA07Level1111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_ID", parent.Level_1_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
