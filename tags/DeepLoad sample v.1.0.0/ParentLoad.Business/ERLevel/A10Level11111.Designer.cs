...
namespace ParentLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// A10Level11111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class A10Level11111 : BusinessBase<A10Level11111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<A11Level111111Child> A11Level111111SingleObjectProperty = RegisterProperty<A11Level111111Child>(p => p.A11Level111111SingleObject, "A11 Level111111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<A11Level111111ReChild> A11Level111111ASingleObjectProperty = RegisterProperty<A11Level111111ReChild>(p => p.A11Level111111ASingleObject, "A11 Level111111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<A11Level111111Coll> A11Level111111ObjectsProperty = RegisterProperty<A11Level111111Coll>(p => p.A11Level111111Objects, "A11 Level111111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="A10Level11111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="A10Level11111"/> object.</returns>
        internal static A10Level11111 NewA10Level11111()
        {
            return DataPortal.CreateChild<A10Level11111>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="A10Level11111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="A10Level11111"/> object in the database.
        /// </summary>
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="A10Level11111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateA10Level11111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="A10Level11111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteA10Level11111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_ID", ReadProperty(Level_1_1_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
