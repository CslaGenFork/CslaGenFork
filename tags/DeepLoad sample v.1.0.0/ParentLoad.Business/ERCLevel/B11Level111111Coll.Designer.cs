...
namespace ParentLoad.Business.ERCLevel
{
    ...
    public partial class B11Level111111Coll : BusinessListBase<B11Level111111Coll, B12Level111111>
    {
        ...
        {
            foreach (var b12Level111111 in this)
            {
        ...
        /// <summary>
        /// Determines whether a <see cref="B12Level111111"/> item is in the collection.
        /// </summary>
        /// <param name="level_1_1_1_1_1_1_ID">The Level_1_1_1_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the B12Level111111 is a collection item; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="B12Level111111"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="level_1_1_1_1_1_1_ID">The Level_1_1_1_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the B12Level111111 is a deleted collection item; otherwise, <c>false</c>.</returns>
        public bool ContainsDeleted(int level_1_1_1_1_1_1_ID)
        {
            foreach (var b12Level111111 in this.DeletedList)
            {
                if (b12Level111111.Level_1_1_1_1_1_1_ID == level_1_1_1_1_1_1_ID)
                {
                    return true;
