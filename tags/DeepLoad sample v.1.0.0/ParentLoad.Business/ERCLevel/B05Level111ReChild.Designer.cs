...
namespace ParentLoad.Business.ERCLevel
{
    ...
    /// <summary>
    /// B05Level111ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class B05Level111ReChild : BusinessBase<B05Level111ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="B05Level111ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="B05Level111ReChild"/> object.</returns>
        internal static B05Level111ReChild NewB05Level111ReChild()
        {
            return DataPortal.CreateChild<B05Level111ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="B05Level111ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="B05Level111ReChild"/> object in the database.
        /// </summary>
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="B05Level111ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        ...
        /// <summary>
        /// Self deletes the <see cref="B05Level111ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(B04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteB05Level111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", parent.Level_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
