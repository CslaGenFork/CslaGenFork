...
namespace ParentLoad.Business.ERCLevel
{
    ...
    /// <summary>
    /// B09Level11111Child (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class B09Level11111Child : BusinessBase<B09Level11111Child>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="B09Level11111Child"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="B09Level11111Child"/> object.</returns>
        internal static B09Level11111Child NewB09Level11111Child()
        {
            return DataPortal.CreateChild<B09Level11111Child>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="B09Level11111Child"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="B09Level11111Child"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(B08Level1111 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddB09Level11111Child", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="B09Level11111Child"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(B08Level1111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateB09Level11111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_ID", parent.Level_1_1_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_Child_Name", ReadProperty(Level_1_1_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="B09Level11111Child"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(B08Level1111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteB09Level11111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_ID", parent.Level_1_1_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
