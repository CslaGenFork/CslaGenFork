...
namespace ParentLoadSoftDelete.Business.ERLevel
{
    ...
    /// <summary>
    /// E04Level11 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class E04Level11 : BusinessBase<E04Level11>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<E05Level111Child> E05Level111SingleObjectProperty = RegisterProperty<E05Level111Child>(p => p.E05Level111SingleObject, "A5 Level111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<E05Level111ReChild> E05Level111ASingleObjectProperty = RegisterProperty<E05Level111ReChild>(p => p.E05Level111ASingleObject, "A5 Level111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<E05Level111Coll> E05Level111ObjectsProperty = RegisterProperty<E05Level111Coll>(p => p.E05Level111Objects, "A5 Level111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="E04Level11"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="E04Level11"/> object.</returns>
        internal static E04Level11 NewE04Level11()
        {
            return DataPortal.CreateChild<E04Level11>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="E04Level11"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            LoadProperty(Level_1_1_IDProperty, System.Threading.Interlocked.Decrement(ref _lastID));
            LoadProperty(E05Level111SingleObjectProperty, DataPortal.CreateChild<E05Level111Child>());
            LoadProperty(E05Level111ASingleObjectProperty, DataPortal.CreateChild<E05Level111ReChild>());
            LoadProperty(E05Level111ObjectsProperty, DataPortal.CreateChild<E05Level111Coll>());
        ...
        /// <summary>
        /// Inserts a new <see cref="E04Level11"/> object in the database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Insert(E02Level1 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddE04Level11", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="E04Level11"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateE04Level11", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="E04Level11"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteE04Level11", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", ReadProperty(Level_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
