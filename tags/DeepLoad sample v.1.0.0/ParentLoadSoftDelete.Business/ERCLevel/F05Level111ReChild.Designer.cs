...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// F05Level111ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class F05Level111ReChild : BusinessBase<F05Level111ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="F05Level111ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="F05Level111ReChild"/> object.</returns>
        internal static F05Level111ReChild NewF05Level111ReChild()
        {
            return DataPortal.CreateChild<F05Level111ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="F05Level111ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="F05Level111ReChild"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(F04Level11 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddF05Level111ReChild", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="F05Level111ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(F04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateF05Level111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", parent.Level_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_Child_Name", ReadProperty(Level_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="F05Level111ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(F04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteF05Level111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", parent.Level_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
