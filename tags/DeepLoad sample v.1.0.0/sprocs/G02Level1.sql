/****** Object:  StoredProcedure [GetG02Level1] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[GetG02Level1]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [GetG02Level1]
GO

CREATE PROCEDURE [GetG02Level1]
    @Level_1_ID int
AS
    BEGIN
...
/****** Object:  StoredProcedure [AddG02Level1] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddG02Level1]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddG02Level1]
GO

CREATE PROCEDURE [AddG02Level1]
...
/****** Object:  StoredProcedure [UpdateG02Level1] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateG02Level1]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateG02Level1]
GO

CREATE PROCEDURE [UpdateG02Level1]
    @Level_1_ID int,
    @Level_1_Name varchar(50)
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''G02Level1'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteG02Level1] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteG02Level1]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteG02Level1]
GO

CREATE PROCEDURE [DeleteG02Level1]
    @Level_1_ID int
AS
    BEGIN
        ...
        /* Mark child G04Level11 as not active */
        UPDATE [Level_1_1]
        SET    [IsActive] = 'false'
        FROM [Level_1_1]
            INNER JOIN [Level_1] ON [Level_1_1].[ParentID1] = [Level_1].[Level_1_ID]
        ...
        /* Mark child G03Level11ReChild as not active */
        ...
        /* Mark child G03Level11Child as not active */
        ...
        /* Mark G02Level1 object as not active */
        UPDATE [Level_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1].[Level_1_ID] = @Level_1_ID
