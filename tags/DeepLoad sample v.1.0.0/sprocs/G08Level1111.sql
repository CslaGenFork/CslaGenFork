/****** Object:  StoredProcedure [AddG08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddG08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddG08Level1111]
GO

CREATE PROCEDURE [AddG08Level1111]
...
/****** Object:  StoredProcedure [UpdateG08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateG08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateG08Level1111]
GO

CREATE PROCEDURE [UpdateG08Level1111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''G08Level1111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteG08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteG08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteG08Level1111]
GO

CREATE PROCEDURE [DeleteG08Level1111]
    @Level_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Mark G08Level1111 object as not active */
        UPDATE [Level_1_1_1_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1_1_1_1].[Level_1_1_1_1_ID] = @Level_1_1_1_1_ID
