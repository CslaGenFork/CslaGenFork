/****** Object:  StoredProcedure [AddE08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddE08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddE08Level1111]
GO

CREATE PROCEDURE [AddE08Level1111]
...
/****** Object:  StoredProcedure [UpdateE08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateE08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateE08Level1111]
GO

CREATE PROCEDURE [UpdateE08Level1111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''E08Level1111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteE08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteE08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteE08Level1111]
GO

CREATE PROCEDURE [DeleteE08Level1111]
    @Level_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Mark E08Level1111 object as not active */
        UPDATE [Level_1_1_1_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1_1_1_1].[Level_1_1_1_1_ID] = @Level_1_1_1_1_ID
