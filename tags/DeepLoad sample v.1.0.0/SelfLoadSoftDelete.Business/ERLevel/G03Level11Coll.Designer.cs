...
namespace SelfLoadSoftDelete.Business.ERLevel
{
    ...
    /// <summary>
    /// G03Level11Coll (editable child list).<br/>
    /// This is a generated base class of <see cref="G03Level11Coll"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is child of <see cref="G02Level1"/> editable root object.<br/>
    /// The items of the collection are <see cref="G04Level11"/> objects.
    /// </remarks>
    [Serializable]
    public partial class G03Level11Coll : BusinessListBase<G03Level11Coll, G04Level11>
    {

        #region Collection Business Methods

        /// <summary>
        /// Removes a <see cref="G04Level11"/> item from the collection.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether a <see cref="G04Level11"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="level_1_1_ID">The Level_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the G04Level11 is a deleted collection item; otherwise, <c>false</c>.</returns>
        public bool ContainsDeleted(int level_1_1_ID)
        {
            foreach (var g04Level11 in this.DeletedList)
            {
                if (g04Level11.Level_1_1_ID == level_1_1_ID)
                {
                    return true;
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="G03Level11Coll"/> collection.
        /// </summary>
        /// <returns>A reference to the created <see cref="G03Level11Coll"/> collection.</returns>
        internal static G03Level11Coll NewG03Level11Coll()
        {
            return DataPortal.CreateChild<G03Level11Coll>();
        }
