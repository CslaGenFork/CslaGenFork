...
namespace CslaGenerator
{
    ...
    /// </summary>
    public partial class CSLAgen : Form
    {
        ...
        void LoadPlugins()
        {
            ...
            foreach (ISimplePlugin plugin in plugins)
            {
                foreach (ScriptCommandInfo cmd in plugin.GetCommands())
                {
                    ...
                    pluginMenu.Tag = cmd;
                    pluginMenu.Click += pluginMenu_Click;
        ...
        public void ShowProjectProperties()
        {
            ...
            {
                MessageBox.Show(@"You need to open or create a project to set its properties.", @"Project properties", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        void Generate()
        {
            ...
            generator = new Templates.CodeGenerator(targetDir, _controller.TemplatesDirectory);
            generator.Step += generator_Step;
            int i = 0;
