...
namespace CslaGenerator.Controls
{
    internal partial class GlobalSettings : DockContent
    {
        ...
        internal bool ApplyGlobalSettings()
        {
            if (IsDirty)
            {
                var result = MessageBox.Show(@"There are unsaved changes in the Global Settings tab. Would you like to apply them now?", @"CslaGenerator", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                switch (result)
                {
