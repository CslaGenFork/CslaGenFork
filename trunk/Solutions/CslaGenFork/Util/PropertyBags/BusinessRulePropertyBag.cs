...
namespace CslaGenerator.Util.PropertyBags
{
    ...
    /// </summary>
    public class BusinessRulePropertyBag : ICustomTypeDescriptor
    {
        ...
        {
            private readonly BusinessRulePropertyBag _bag;
            private readonly PropertySpec _item;

            public PropertySpecDescriptor(PropertySpec item, BusinessRulePropertyBag bag, string name, Attribute[] attrs)
                : base(name, attrs)
            {
                _bag = bag;
                _item = item;
        ...
        private BusinessRuleProperty[] _selectedObject;
        ...
        /// Gets or sets the name of the default property in the collection.
        /// </summary>
        public BusinessRuleProperty[] SelectedObject
        {
        ...
        /// <summary>
        /// Gets the collection of properties contained within this BusinessRulePropertyBag.
        /// </summary>
        ...
        {
            PropertyInfo pi;
            Type t = typeof (BusinessRuleProperty); // _selectedObject.GetType();
            ...
            for (int i = 0; i < props.Length; i++)
            {
                ...
                BusinessRuleProperty target = SelectedObject[0];
        ...
        public static Type GetDataType(BusinessRuleProperty target, out string assemblyQualifiedName, out string editor)
        {
        ...
        private PropertyInfo GetPropertyInfoCache(string propertyName)
        {
            ...
            {
                propertyInfoCache.Add(propertyName, typeof (BusinessRuleProperty).GetProperty(propertyName));
            }
        ...
        private bool SetProperty(object obj, string propertyName, object val)
        {
            try
            {
                ...
                // name
                PropertyInfo pi = typeof (BusinessRuleProperty).GetProperty(propertyName);
                ...
                foreach (BusinessRuleProperty bo in (BusinessRuleProperty[]) obj)
        ...
        private object GetProperty(object obj, string propertyName, object defaultValue)
        {
            try
            {
                ...
                if (!(pi == null))
                {
                    var objs = (BusinessRuleProperty[]) obj;
                    var valueList = new ArrayList();

                    foreach (BusinessRuleProperty bo in objs)
                    {
        ...
        PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties(Attribute[] attributes)
        {
            ...
            // which would return the actual properties of BusinessRulePropertyBag, I construct
