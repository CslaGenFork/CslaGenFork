...
namespace CslaGenerator.Util.PropertyBags
{
    ...
    /// </summary>
    public class UnitOfWorkPropertyBag : ICustomTypeDescriptor
    {
        ...
        {
            private readonly UnitOfWorkPropertyBag _bag;
            private readonly PropertySpec _item;

            public PropertySpecDescriptor(PropertySpec item, UnitOfWorkPropertyBag bag, string name, Attribute[] attrs)
                :
                    base(name, attrs)
            {
                _bag = bag;
        ...
        private UnitOfWorkProperty[] _selectedObject;
        ...
        /// Gets or sets the name of the default property in the collection.
        /// </summary>
        public UnitOfWorkProperty[] SelectedObject
        {
        ...
        /// <summary>
        /// Gets the collection of properties contained within this UnitOfWorkPropertyBag.
        /// </summary>
        ...
        private PropertyInfo GetPropertyInfoCache(string propertyName)
        {
            ...
            {
                propertyInfoCache.Add(propertyName, typeof(UnitOfWorkProperty).GetProperty(propertyName));
            }
        ...
        PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties(Attribute[] attributes)
        {
            ...
            // which would return the actual properties of UnitOfWorkPropertyBag, I construct
