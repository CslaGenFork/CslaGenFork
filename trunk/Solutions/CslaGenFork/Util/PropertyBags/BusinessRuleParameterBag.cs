...
namespace CslaGenerator.Util.PropertyBags
{
    ...
    /// </summary>
    public class BusinessRuleParameterBag : ICustomTypeDescriptor
    {
        ...
        {
            private readonly BusinessRuleParameterBag _bag;
            private readonly PropertySpec _item;

            public PropertySpecDescriptor(PropertySpec item, BusinessRuleParameterBag bag, string name, Attribute[] attrs)
                : base(name, attrs)
            {
                _bag = bag;
                _item = item;
        ...
        /// </summary>
        public BusinessRuleParameterBag()
        {
        ...
        /// <summary>
        /// Gets the collection of properties contained within this BusinessRuleParameterBag.
        /// </summary>
        ...
        PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties(Attribute[] attributes)
        {
            ...
            // which would return the actual properties of BusinessRuleParameterBag, I construct
