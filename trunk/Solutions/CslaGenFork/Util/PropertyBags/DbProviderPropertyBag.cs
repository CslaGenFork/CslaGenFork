...
namespace CslaGenerator.Util.PropertyBags
{
    ...
    /// </summary>
    public class DbProviderPropertyBag : ICustomTypeDescriptor
    {
        ...
        {
            private readonly DbProviderPropertyBag _bag;
            private readonly PropertySpec _item;

            public PropertySpecDescriptor(PropertySpec item, DbProviderPropertyBag bag, string name, Attribute[] attrs)
                :
                    base(name, attrs)
            {
                _bag = bag;
        ...
        private DbProvider[] _selectedObject;
        ...
        public DbProviderPropertyBag(DbProvider obj) : this(new[] {obj})
        {
        }
        ...
        /// Gets or sets the name of the default property in the collection.
        /// </summary>
        public DbProvider[] SelectedObject
        {
        ...
        /// <summary>
        /// Gets the collection of properties contained within this DbProviderPropertyBag.
        /// </summary>
        ...
        private void InitPropertyBag()
        {
            ...
            Type t = typeof(DbProvider);// _selectedObject.GetType();
        ...
        private PropertyInfo GetPropertyInfoCache(string propertyName)
        {
            ...
            {
                propertyInfoCache.Add(propertyName, typeof (DbProvider).GetProperty(propertyName));
            }
        ...
        private bool SetProperty(object obj, string propertyName, object val)
        {
            try
            {
                ...
                PropertyInfo propertyInfo = typeof (DbProvider).GetProperty(propertyName);
                ...
                foreach (DbProvider bo in (DbProvider[]) obj)
        ...
        private object GetProperty(object obj, string propertyName, object defaultValue)
        {
            try
            {
                ...
                if (!(propertyInfo == null))
                {
                    var objs = (DbProvider[]) obj;
                    var valueList = new ArrayList();

                    foreach (DbProvider bo in objs)
                    {
        ...
        PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties(Attribute[] attributes)
        {
            ...
            // which would return the actual properties of DbProviderPropertyBag, I construct
