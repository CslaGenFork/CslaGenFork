...
namespace SelfLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// H11_City_Child (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class H11_City_Child : BusinessBase<H11_City_Child>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="H11_City_Child"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="H11_City_Child"/> object.</returns>
        internal static H11_City_Child NewH11_City_Child()
        {
            return DataPortal.CreateChild<H11_City_Child>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="H11_City_Child"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="H11_City_Child"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="H11_City_Child"/> object in the database.
        /// </summary>
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="H11_City_Child"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        ...
        /// <summary>
        /// Self deletes the <see cref="H11_City_Child"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
