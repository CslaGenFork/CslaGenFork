...
namespace SelfLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// H08Level1111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class H08Level1111 : BusinessBase<H08Level1111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<H09Level11111Child> H09Level11111SingleObjectProperty = RegisterProperty<H09Level11111Child>(p => p.H09Level11111SingleObject, "H09 Level11111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<H09Level11111ReChild> H09Level11111ASingleObjectProperty = RegisterProperty<H09Level11111ReChild>(p => p.H09Level11111ASingleObject, "H09 Level11111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<H09Level11111Coll> H09Level11111ObjectsProperty = RegisterProperty<H09Level11111Coll>(p => p.H09Level11111Objects, "H09 Level11111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="H08Level1111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="H08Level1111"/> object.</returns>
        internal static H08Level1111 NewH08Level1111()
        {
            return DataPortal.CreateChild<H08Level1111>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="H08Level1111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            LoadProperty(Level_1_1_1_1_IDProperty, System.Threading.Interlocked.Decrement(ref _lastID));
            LoadProperty(H09Level11111SingleObjectProperty, DataPortal.CreateChild<H09Level11111Child>());
            LoadProperty(H09Level11111ASingleObjectProperty, DataPortal.CreateChild<H09Level11111ReChild>());
            LoadProperty(H09Level11111ObjectsProperty, DataPortal.CreateChild<H09Level11111Coll>());
        ...
        /// <summary>
        /// Inserts a new <see cref="H08Level1111"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(H06Level111 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddH08Level1111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="H08Level1111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateH08Level1111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="H08Level1111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteH08Level1111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_ID", ReadProperty(Level_1_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
