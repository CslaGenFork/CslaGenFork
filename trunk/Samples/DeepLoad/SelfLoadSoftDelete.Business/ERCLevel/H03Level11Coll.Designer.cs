...
namespace SelfLoadSoftDelete.Business.ERCLevel
{
    ...
    public partial class H03Level11Coll : BusinessListBase<H03Level11Coll, H04Level11>
    {
        ...
        /// <summary>
        /// Determines whether a <see cref="H04Level11"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="level_1_1_ID">The Level_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the H04Level11 is a deleted collection item; otherwise, <c>false</c>.</returns>
        public bool ContainsDeleted(int level_1_1_ID)
        {
            foreach (var h04Level11 in this.DeletedList)
            {
                if (h04Level11.Level_1_1_ID == level_1_1_ID)
                {
                    return true;
