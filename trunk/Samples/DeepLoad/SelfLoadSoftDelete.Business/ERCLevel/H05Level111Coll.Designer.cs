...
namespace SelfLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// H05Level111Coll (editable child list).<br/>
    /// This is a generated base class of <see cref="H05Level111Coll"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is child of <see cref="H04Level11"/> editable child object.<br/>
    /// The items of the collection are <see cref="H06Level111"/> objects.
    /// </remarks>
    [Serializable]
    public partial class H05Level111Coll : BusinessListBase<H05Level111Coll, H06Level111>
    {

        #region Collection Business Methods

        /// <summary>
        /// Removes a <see cref="H06Level111"/> item from the collection.
        /// </summary>
        /// <param name="level_1_1_1_ID">The Level_1_1_1_ID of the item to be removed.</param>
        public void Remove(int level_1_1_1_ID)
        {
            foreach (var h06Level111 in this)
            {
                if (h06Level111.Level_1_1_1_ID == level_1_1_1_ID)
                {
                    Remove(h06Level111);
                    break;
                }
        ...
        /// <summary>
        /// Determines whether a <see cref="H06Level111"/> item is in the collection.
        /// </summary>
        /// <param name="level_1_1_1_ID">The Level_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the H06Level111 is a collection item; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="H06Level111"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="level_1_1_1_ID">The Level_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the H06Level111 is a deleted collection item; otherwise, <c>false</c>.</returns>
        public bool ContainsDeleted(int level_1_1_1_ID)
        {
            foreach (var h06Level111 in this.DeletedList)
            {
                if (h06Level111.Level_1_1_1_ID == level_1_1_1_ID)
                {
                    return true;
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="H05Level111Coll"/> collection.
        /// </summary>
        /// <returns>A reference to the created <see cref="H05Level111Coll"/> collection.</returns>
        internal static H05Level111Coll NewH05Level111Coll()
        {
            return DataPortal.CreateChild<H05Level111Coll>();
        }
