...
namespace SelfLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// H07Level1111Child (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class H07Level1111Child : BusinessBase<H07Level1111Child>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="H07Level1111Child"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="H07Level1111Child"/> object.</returns>
        internal static H07Level1111Child NewH07Level1111Child()
        {
            return DataPortal.CreateChild<H07Level1111Child>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="H07Level1111Child"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="H07Level1111Child"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(H06Level111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddH07Level1111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="H07Level1111Child"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(H06Level111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateH07Level1111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_ID", parent.Level_1_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_Child_Name", ReadProperty(Level_1_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="H07Level1111Child"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(H06Level111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteH07Level1111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_ID", parent.Level_1_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
