...
namespace SelfLoadSoftDelete.Business.ERLevel
{
    ...
    /// <summary>
    /// G03Level11ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class G03Level11ReChild : BusinessBase<G03Level11ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="G03Level11ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="G03Level11ReChild"/> object.</returns>
        internal static G03Level11ReChild NewG03Level11ReChild()
        {
            return DataPortal.CreateChild<G03Level11ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="G03Level11ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="G03Level11ReChild"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(G02Level1 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddG03Level11ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="G03Level11ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(G02Level1 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateG03Level11ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_ID", parent.Level_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_Child_Name", ReadProperty(Level_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="G03Level11ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(G02Level1 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteG03Level11ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_ID", parent.Level_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
