...
namespace SelfLoadSoftDelete.Business.ERLevel
{
    ...
    /// <summary>
    /// G06Level111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class G06Level111 : BusinessBase<G06Level111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<G07Level1111Child> G07Level1111SingleObjectProperty = RegisterProperty<G07Level1111Child>(p => p.G07Level1111SingleObject, "A7 Level1111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<G07Level1111ReChild> G07Level1111ASingleObjectProperty = RegisterProperty<G07Level1111ReChild>(p => p.G07Level1111ASingleObject, "A7 Level1111 ASimple Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<G07Level1111Coll> G07Level1111ObjectsProperty = RegisterProperty<G07Level1111Coll>(p => p.G07Level1111Objects, "A7 Level1111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="G06Level111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="G06Level111"/> object.</returns>
        internal static G06Level111 NewG06Level111()
        {
            return DataPortal.CreateChild<G06Level111>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="G06Level111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            LoadProperty(Level_1_1_1_IDProperty, System.Threading.Interlocked.Decrement(ref _lastID));
            LoadProperty(G07Level1111SingleObjectProperty, DataPortal.CreateChild<G07Level1111Child>());
            LoadProperty(G07Level1111ASingleObjectProperty, DataPortal.CreateChild<G07Level1111ReChild>());
            LoadProperty(G07Level1111ObjectsProperty, DataPortal.CreateChild<G07Level1111Coll>());
        ...
        /// <summary>
        /// Inserts a new <see cref="G06Level111"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(G04Level11 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddG06Level111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="G06Level111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateG06Level111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="G06Level111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteG06Level111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_ID", ReadProperty(Level_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
