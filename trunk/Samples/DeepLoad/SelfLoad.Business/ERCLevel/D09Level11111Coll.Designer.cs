...
namespace SelfLoad.Business.ERCLevel
{
    ...
    public partial class D09Level11111Coll : BusinessListBase<D09Level11111Coll, D10Level11111>
    {
        ...
        {
            foreach (var d10Level11111 in this)
            {
        ...
        /// <summary>
        /// Determines whether a <see cref="D10Level11111"/> item is in the collection.
        /// </summary>
        /// <param name="level_1_1_1_1_1_ID">The Level_1_1_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the D10Level11111 is a collection item; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="D10Level11111"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="level_1_1_1_1_1_ID">The Level_1_1_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the D10Level11111 is a deleted collection item; otherwise, <c>false</c>.</returns>
        public bool ContainsDeleted(int level_1_1_1_1_1_ID)
        {
            foreach (var d10Level11111 in this.DeletedList)
            {
                if (d10Level11111.Level_1_1_1_1_1_ID == level_1_1_1_1_1_ID)
                {
                    return true;
