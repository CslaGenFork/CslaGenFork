...
namespace SelfLoad.Business.ERCLevel
{
    ...
    public partial class D11Level111111Coll : BusinessListBase<D11Level111111Coll, D12Level111111>
    {
        ...
        {
            foreach (var d12Level111111 in this)
            {
        ...
        /// <summary>
        /// Determines whether a <see cref="D12Level111111"/> item is in the collection.
        /// </summary>
        /// <param name="level_1_1_1_1_1_1_ID">The Level_1_1_1_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the D12Level111111 is a collection item; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="D12Level111111"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="level_1_1_1_1_1_1_ID">The Level_1_1_1_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the D12Level111111 is a deleted collection item; otherwise, <c>false</c>.</returns>
        public bool ContainsDeleted(int level_1_1_1_1_1_1_ID)
        {
            foreach (var d12Level111111 in this.DeletedList)
            {
                if (d12Level111111.Level_1_1_1_1_1_1_ID == level_1_1_1_1_1_1_ID)
                {
                    return true;
