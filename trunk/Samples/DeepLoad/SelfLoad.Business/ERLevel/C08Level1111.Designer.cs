...
namespace SelfLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// C08Level1111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class C08Level1111 : BusinessBase<C08Level1111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<C09Level11111Child> C09Level11111SingleObjectProperty = RegisterProperty<C09Level11111Child>(p => p.C09Level11111SingleObject, "C09 Level11111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<C09Level11111ReChild> C09Level11111ASingleObjectProperty = RegisterProperty<C09Level11111ReChild>(p => p.C09Level11111ASingleObject, "C09 Level11111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<C09Level11111Coll> C09Level11111ObjectsProperty = RegisterProperty<C09Level11111Coll>(p => p.C09Level11111Objects, "C09 Level11111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="C08Level1111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="C08Level1111"/> object.</returns>
        internal static C08Level1111 NewC08Level1111()
        {
            return DataPortal.CreateChild<C08Level1111>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="C08Level1111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            LoadProperty(Level_1_1_1_1_IDProperty, System.Threading.Interlocked.Decrement(ref _lastID));
            LoadProperty(C09Level11111SingleObjectProperty, DataPortal.CreateChild<C09Level11111Child>());
            LoadProperty(C09Level11111ASingleObjectProperty, DataPortal.CreateChild<C09Level11111ReChild>());
            LoadProperty(C09Level11111ObjectsProperty, DataPortal.CreateChild<C09Level11111Coll>());
        ...
        /// <summary>
        /// Inserts a new <see cref="C08Level1111"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(C06Level111 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddC08Level1111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="C08Level1111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateC08Level1111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="C08Level1111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteC08Level1111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_ID", ReadProperty(Level_1_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
