...
namespace SelfLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// C05Level111Child (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class C05Level111Child : BusinessBase<C05Level111Child>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="C05Level111Child"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="C05Level111Child"/> object.</returns>
        internal static C05Level111Child NewC05Level111Child()
        {
            return DataPortal.CreateChild<C05Level111Child>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="C05Level111Child"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="C05Level111Child"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(C04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddC05Level111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="C05Level111Child"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(C04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateC05Level111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", parent.Level_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_Child_Name", ReadProperty(Level_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="C05Level111Child"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(C04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteC05Level111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", parent.Level_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
