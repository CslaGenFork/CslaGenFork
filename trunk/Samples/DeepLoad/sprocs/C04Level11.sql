/****** Object:  StoredProcedure [AddC04Level11] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddC04Level11]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddC04Level11]
GO

CREATE PROCEDURE [AddC04Level11]
...
/****** Object:  StoredProcedure [UpdateC04Level11] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateC04Level11]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateC04Level11]
GO

CREATE PROCEDURE [UpdateC04Level11]
    @Level_1_1_ID int,
    @Level_1_1_Name varchar(50)
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''C04Level11'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteC04Level11] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteC04Level11]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteC04Level11]
GO

CREATE PROCEDURE [DeleteC04Level11]
    @Level_1_1_ID int
AS
    BEGIN
        ...
        /* Delete C04Level11 object from Level_1_1 */
        DELETE
        FROM [Level_1_1]
        WHERE
            [Level_1_1_ID] = @Level_1_1_ID
