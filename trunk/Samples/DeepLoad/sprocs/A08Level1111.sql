/****** Object:  StoredProcedure [AddA08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddA08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddA08Level1111]
GO

CREATE PROCEDURE [AddA08Level1111]
...
/****** Object:  StoredProcedure [UpdateA08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateA08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateA08Level1111]
GO

CREATE PROCEDURE [UpdateA08Level1111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''A08Level1111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteA08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteA08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteA08Level1111]
GO

CREATE PROCEDURE [DeleteA08Level1111]
    @Level_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Delete A08Level1111 object from Level_1_1_1_1 */
        DELETE
        FROM [Level_1_1_1_1]
        WHERE
            [Level_1_1_1_1].[Level_1_1_1_1_ID] = @Level_1_1_1_1_ID
