/****** Object:  StoredProcedure [AddC04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddC04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddC04_SubContinent]
GO

CREATE PROCEDURE [AddC04_SubContinent]
...
/****** Object:  StoredProcedure [UpdateC04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateC04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateC04_SubContinent]
GO

CREATE PROCEDURE [UpdateC04_SubContinent]
    @SubContinent_ID int,
    @SubContinent_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteC04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteC04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteC04_SubContinent]
GO

CREATE PROCEDURE [DeleteC04_SubContinent]
    @SubContinent_ID int
AS
    BEGIN
