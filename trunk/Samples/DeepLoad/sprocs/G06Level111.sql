/****** Object:  StoredProcedure [AddG06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddG06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddG06Level111]
GO

CREATE PROCEDURE [AddG06Level111]
...
/****** Object:  StoredProcedure [UpdateG06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateG06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateG06Level111]
GO

CREATE PROCEDURE [UpdateG06Level111]
    @Level_1_1_1_ID int,
    @Level_1_1_1_Name varchar(50),
    @MarentID1 int,
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''G06Level111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
        ...
        BEGIN
            RAISERROR ('''G06Level111'' object was modified by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteG06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteG06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteG06Level111]
GO

CREATE PROCEDURE [DeleteG06Level111]
    @Level_1_1_1_ID int
AS
    BEGIN
        ...
        /* Mark G06Level111 object as not active */
        UPDATE [Level_1_1_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1_1_1_ID] = @Level_1_1_1_ID
