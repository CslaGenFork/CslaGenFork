/****** Object:  StoredProcedure [AddE06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddE06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddE06Level111]
GO

CREATE PROCEDURE [AddE06Level111]
...
/****** Object:  StoredProcedure [UpdateE06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateE06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateE06Level111]
GO

CREATE PROCEDURE [UpdateE06Level111]
    @Level_1_1_1_ID int,
    @Level_1_1_1_Name varchar(50),
    @MarentID1 int,
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''E06Level111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
        ...
        BEGIN
            RAISERROR ('''E06Level111'' object was modified by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteE06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteE06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteE06Level111]
GO

CREATE PROCEDURE [DeleteE06Level111]
    @Level_1_1_1_ID int
AS
    BEGIN
        ...
        /* Mark E06Level111 object as not active */
        UPDATE [Level_1_1_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1_1_1].[Level_1_1_1_ID] = @Level_1_1_1_ID
