/****** Object:  StoredProcedure [AddD08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddD08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddD08Level1111]
GO

CREATE PROCEDURE [AddD08Level1111]
...
/****** Object:  StoredProcedure [UpdateD08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateD08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateD08Level1111]
GO

CREATE PROCEDURE [UpdateD08Level1111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''D08Level1111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteD08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteD08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteD08Level1111]
GO

CREATE PROCEDURE [DeleteD08Level1111]
    @Level_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Delete D08Level1111 object from Level_1_1_1_1 */
        DELETE
        FROM [Level_1_1_1_1]
        WHERE
            [Level_1_1_1_1_ID] = @Level_1_1_1_1_ID
