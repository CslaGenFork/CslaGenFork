/****** Object:  StoredProcedure [AddD10_City] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddD10_City]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddD10_City]
GO

CREATE PROCEDURE [AddD10_City]
    @City_ID int OUTPUT,
...
/****** Object:  StoredProcedure [UpdateD10_City] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateD10_City]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateD10_City]
GO

CREATE PROCEDURE [UpdateD10_City]
    @City_ID int,
    @City_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteD10_City] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteD10_City]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteD10_City]
GO

CREATE PROCEDURE [DeleteD10_City]
    @City_ID int
AS
    BEGIN
