/****** Object:  StoredProcedure [AddH04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddH04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddH04_SubContinent]
GO

CREATE PROCEDURE [AddH04_SubContinent]
...
/****** Object:  StoredProcedure [UpdateH04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateH04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateH04_SubContinent]
GO

CREATE PROCEDURE [UpdateH04_SubContinent]
    @SubContinent_ID int,
    @SubContinent_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteH04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteH04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteH04_SubContinent]
GO

CREATE PROCEDURE [DeleteH04_SubContinent]
    @SubContinent_ID int
AS
    BEGIN
