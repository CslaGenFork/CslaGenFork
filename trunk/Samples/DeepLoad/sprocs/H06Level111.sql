/****** Object:  StoredProcedure [AddH06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddH06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddH06Level111]
GO

CREATE PROCEDURE [AddH06Level111]
...
/****** Object:  StoredProcedure [UpdateH06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateH06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateH06Level111]
GO

CREATE PROCEDURE [UpdateH06Level111]
    @Level_1_1_1_ID int,
    @Level_1_1_1_Name varchar(50)
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''H06Level111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteH06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteH06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteH06Level111]
GO

CREATE PROCEDURE [DeleteH06Level111]
    @Level_1_1_1_ID int
AS
    BEGIN
        ...
        /* Mark H06Level111 object as not active */
        UPDATE [Level_1_1_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1_1_1_ID] = @Level_1_1_1_ID
