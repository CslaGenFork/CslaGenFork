/****** Object:  StoredProcedure [AddG10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddG10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddG10Level11111]
GO

CREATE PROCEDURE [AddG10Level11111]
...
/****** Object:  StoredProcedure [UpdateG10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateG10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateG10Level11111]
GO

CREATE PROCEDURE [UpdateG10Level11111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''G10Level11111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteG10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteG10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteG10Level11111]
GO

CREATE PROCEDURE [DeleteG10Level11111]
    @Level_1_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Mark G10Level11111 object as not active */
        UPDATE [Level_1_1_1_1_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1_1_1_1_1].[Level_1_1_1_1_1_ID] = @Level_1_1_1_1_1_ID
