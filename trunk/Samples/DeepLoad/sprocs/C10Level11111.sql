/****** Object:  StoredProcedure [AddC10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddC10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddC10Level11111]
GO

CREATE PROCEDURE [AddC10Level11111]
...
/****** Object:  StoredProcedure [UpdateC10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateC10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateC10Level11111]
GO

CREATE PROCEDURE [UpdateC10Level11111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''C10Level11111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteC10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteC10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteC10Level11111]
GO

CREATE PROCEDURE [DeleteC10Level11111]
    @Level_1_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Delete C10Level11111 object from Level_1_1_1_1_1 */
        DELETE
