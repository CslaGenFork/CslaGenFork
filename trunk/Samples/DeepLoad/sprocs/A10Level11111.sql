/****** Object:  StoredProcedure [AddA10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddA10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddA10Level11111]
GO

CREATE PROCEDURE [AddA10Level11111]
...
/****** Object:  StoredProcedure [UpdateA10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateA10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateA10Level11111]
GO

CREATE PROCEDURE [UpdateA10Level11111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''A10Level11111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteA10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteA10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteA10Level11111]
GO

CREATE PROCEDURE [DeleteA10Level11111]
    @Level_1_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Delete A10Level11111 object from Level_1_1_1_1_1 */
        DELETE
