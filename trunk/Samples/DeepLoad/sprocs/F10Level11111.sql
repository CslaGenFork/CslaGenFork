/****** Object:  StoredProcedure [AddF10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddF10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddF10Level11111]
GO

CREATE PROCEDURE [AddF10Level11111]
...
/****** Object:  StoredProcedure [UpdateF10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateF10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateF10Level11111]
GO

CREATE PROCEDURE [UpdateF10Level11111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''F10Level11111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteF10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteF10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteF10Level11111]
GO

CREATE PROCEDURE [DeleteF10Level11111]
    @Level_1_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Mark F10Level11111 object as not active */
        UPDATE [Level_1_1_1_1_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1_1_1_1_1].[Level_1_1_1_1_1_ID] = @Level_1_1_1_1_1_ID
