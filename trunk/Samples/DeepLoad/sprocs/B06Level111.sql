/****** Object:  StoredProcedure [AddB06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddB06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddB06Level111]
GO

CREATE PROCEDURE [AddB06Level111]
...
/****** Object:  StoredProcedure [UpdateB06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateB06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateB06Level111]
GO

CREATE PROCEDURE [UpdateB06Level111]
    @Level_1_1_1_ID int,
    @Level_1_1_1_Name varchar(50)
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''B06Level111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteB06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteB06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteB06Level111]
GO

CREATE PROCEDURE [DeleteB06Level111]
    @Level_1_1_1_ID int
AS
    BEGIN
        ...
        /* Delete B06Level111 object from Level_1_1_1 */
        DELETE
        FROM [Level_1_1_1]
        WHERE
            [Level_1_1_1_ID] = @Level_1_1_1_ID
