/****** Object:  StoredProcedure [AddC06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddC06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddC06Level111]
GO

CREATE PROCEDURE [AddC06Level111]
...
/****** Object:  StoredProcedure [UpdateC06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateC06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateC06Level111]
GO

CREATE PROCEDURE [UpdateC06Level111]
    @Level_1_1_1_ID int,
    @Level_1_1_1_Name varchar(50),
    @MarentID1 int,
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''C06Level111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
        ...
        BEGIN
            RAISERROR ('''C06Level111'' object was modified by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteC06Level111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteC06Level111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteC06Level111]
GO

CREATE PROCEDURE [DeleteC06Level111]
    @Level_1_1_1_ID int
AS
    BEGIN
        ...
        /* Delete C06Level111 object from Level_1_1_1 */
        DELETE
        FROM [Level_1_1_1]
        WHERE
            [Level_1_1_1].[Level_1_1_1_ID] = @Level_1_1_1_ID
