/****** Object:  StoredProcedure [AddF08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddF08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddF08Level1111]
GO

CREATE PROCEDURE [AddF08Level1111]
...
/****** Object:  StoredProcedure [UpdateF08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateF08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateF08Level1111]
GO

CREATE PROCEDURE [UpdateF08Level1111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''F08Level1111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteF08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteF08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteF08Level1111]
GO

CREATE PROCEDURE [DeleteF08Level1111]
    @Level_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Mark F08Level1111 object as not active */
        UPDATE [Level_1_1_1_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1_1_1_1_ID] = @Level_1_1_1_1_ID
