/****** Object:  StoredProcedure [AddB10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddB10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddB10Level11111]
GO

CREATE PROCEDURE [AddB10Level11111]
...
/****** Object:  StoredProcedure [UpdateB10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateB10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateB10Level11111]
GO

CREATE PROCEDURE [UpdateB10Level11111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''B10Level11111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteB10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteB10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteB10Level11111]
GO

CREATE PROCEDURE [DeleteB10Level11111]
    @Level_1_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Delete B10Level11111 object from Level_1_1_1_1_1 */
        DELETE
