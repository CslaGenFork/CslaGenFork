/****** Object:  StoredProcedure [AddH10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddH10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddH10Level11111]
GO

CREATE PROCEDURE [AddH10Level11111]
...
/****** Object:  StoredProcedure [UpdateH10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateH10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateH10Level11111]
GO

CREATE PROCEDURE [UpdateH10Level11111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''H10Level11111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteH10Level11111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteH10Level11111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteH10Level11111]
GO

CREATE PROCEDURE [DeleteH10Level11111]
    @Level_1_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Mark H10Level11111 object as not active */
        UPDATE [Level_1_1_1_1_1]
        SET    [IsActive] = 'false'
        WHERE
            [Level_1_1_1_1_1_ID] = @Level_1_1_1_1_1_ID
