/****** Object:  StoredProcedure [AddB04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddB04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddB04_SubContinent]
GO

CREATE PROCEDURE [AddB04_SubContinent]
...
/****** Object:  StoredProcedure [UpdateB04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateB04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateB04_SubContinent]
GO

CREATE PROCEDURE [UpdateB04_SubContinent]
    @SubContinent_ID int,
    @SubContinent_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteB04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteB04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteB04_SubContinent]
GO

CREATE PROCEDURE [DeleteB04_SubContinent]
    @SubContinent_ID int
AS
    BEGIN
