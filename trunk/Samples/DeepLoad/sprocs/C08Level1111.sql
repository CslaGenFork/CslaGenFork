/****** Object:  StoredProcedure [AddC08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddC08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddC08Level1111]
GO

CREATE PROCEDURE [AddC08Level1111]
...
/****** Object:  StoredProcedure [UpdateC08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateC08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateC08Level1111]
GO

CREATE PROCEDURE [UpdateC08Level1111]
...
AS
    BEGIN
        ...
        BEGIN
            RAISERROR ('''C08Level1111'' object not found. It was probably removed by another user.', 16, 1)
            RETURN
        END
...
/****** Object:  StoredProcedure [DeleteC08Level1111] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteC08Level1111]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteC08Level1111]
GO

CREATE PROCEDURE [DeleteC08Level1111]
    @Level_1_1_1_1_ID int
AS
    BEGIN
        ...
        /* Delete C08Level1111 object from Level_1_1_1_1 */
        DELETE
        FROM [Level_1_1_1_1]
        WHERE
            [Level_1_1_1_1_ID] = @Level_1_1_1_1_ID
