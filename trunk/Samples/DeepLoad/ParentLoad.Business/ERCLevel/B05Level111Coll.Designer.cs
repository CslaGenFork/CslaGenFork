...
namespace ParentLoad.Business.ERCLevel
{
    ...
    public partial class B05Level111Coll : BusinessListBase<B05Level111Coll, B06Level111>
    {
        ...
        /// <summary>
        /// Determines whether a <see cref="B06Level111"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="level_1_1_1_ID">The Level_1_1_1_ID of the item to search for.</param>
        /// <returns><c>true</c> if the B06Level111 is a deleted collection item; otherwise, <c>false</c>.</returns>
        public bool ContainsDeleted(int level_1_1_1_ID)
        {
            foreach (var b06Level111 in this.DeletedList)
            {
                if (b06Level111.Level_1_1_1_ID == level_1_1_1_ID)
                {
                    return true;
