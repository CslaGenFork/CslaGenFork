...
namespace ParentLoad.Business.ERCLevel
{
    ...
    /// <summary>
    /// B11Level111111ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class B11Level111111ReChild : BusinessBase<B11Level111111ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="B11Level111111ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="B11Level111111ReChild"/> object.</returns>
        internal static B11Level111111ReChild NewB11Level111111ReChild()
        {
            return DataPortal.CreateChild<B11Level111111ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="B11Level111111ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="B11Level111111ReChild"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(B10Level11111 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddB11Level111111ReChild", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="B11Level111111ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(B10Level11111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateB11Level111111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_ID", parent.Level_1_1_1_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_1_Child_Name", ReadProperty(Level_1_1_1_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="B11Level111111ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(B10Level11111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteB11Level111111ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_ID", parent.Level_1_1_1_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
