...
namespace ParentLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// A05Level111Child (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class A05Level111Child : BusinessBase<A05Level111Child>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="A05Level111Child"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="A05Level111Child"/> object.</returns>
        internal static A05Level111Child NewA05Level111Child()
        {
            return DataPortal.CreateChild<A05Level111Child>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="A05Level111Child"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="A05Level111Child"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(A04Level11 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddA05Level111Child", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="A05Level111Child"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(A04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateA05Level111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", parent.Level_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_Child_Name", ReadProperty(Level_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="A05Level111Child"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(A04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteA05Level111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", parent.Level_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
