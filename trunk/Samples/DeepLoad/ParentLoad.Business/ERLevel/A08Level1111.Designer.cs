...
namespace ParentLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// A08Level1111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class A08Level1111 : BusinessBase<A08Level1111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<A09Level11111Child> A09Level11111SingleObjectProperty = RegisterProperty<A09Level11111Child>(p => p.A09Level11111SingleObject, "A09 Level11111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<A09Level11111ReChild> A09Level11111ASingleObjectProperty = RegisterProperty<A09Level11111ReChild>(p => p.A09Level11111ASingleObject, "A09 Level11111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<A09Level11111Coll> A09Level11111ObjectsProperty = RegisterProperty<A09Level11111Coll>(p => p.A09Level11111Objects, "A09 Level11111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="A08Level1111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="A08Level1111"/> object.</returns>
        internal static A08Level1111 NewA08Level1111()
        {
            return DataPortal.CreateChild<A08Level1111>();
        }
        ...
        internal static A08Level1111 GetA08Level1111(SafeDataReader dr)
        {
            ...
            obj.MarkAsChild();
            obj.Fetch(dr);
            obj.LoadProperty(A09Level11111ObjectsProperty, A09Level11111Coll.NewA09Level11111Coll());
            obj.MarkOld();
            return obj;
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="A08Level1111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="A08Level1111"/> object in the database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Insert(A06Level111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddA08Level1111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="A08Level1111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateA08Level1111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="A08Level1111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
