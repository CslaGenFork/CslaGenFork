...
namespace ParentLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// A03Level11Child (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class A03Level11Child : BusinessBase<A03Level11Child>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="A03Level11Child"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="A03Level11Child"/> object.</returns>
        internal static A03Level11Child NewA03Level11Child()
        {
            return DataPortal.CreateChild<A03Level11Child>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="A03Level11Child"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="A03Level11Child"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(A02Level1 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddA03Level11Child", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="A03Level11Child"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(A02Level1 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateA03Level11Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_ID", parent.Level_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_Child_Name", ReadProperty(Level_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="A03Level11Child"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(A02Level1 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteA03Level11Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_ID", parent.Level_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
