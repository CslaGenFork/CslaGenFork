...
namespace ParentLoadRO.Business.ERCLevel
{
    ...
    public partial class B09_CityColl : ReadOnlyListBase<B09_CityColl, B10_City>
    {
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="B09_CityColl"/> object from the given list of B10_CityDto.
        /// </summary>
        /// <param name="data">The list of <see cref="B10_CityDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="B09_CityColl"/> object.</returns>
        internal static B09_CityColl GetB09_CityColl(List<B10_CityDto> data)
        {
        ...
        /// <summary>
        /// Loads all <see cref="B09_CityColl"/> collection items from the given list of B10_CityDto.
        /// </summary>
        /// <param name="data">The list of <see cref="B10_CityDto"/>.</param>
        private void Fetch(List<B10_CityDto> data)
        {
            IsReadOnly = false;
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
