/****** Object:  StoredProcedure [AddD04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddD04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddD04_SubContinent]
GO

CREATE PROCEDURE [AddD04_SubContinent]
...
/****** Object:  StoredProcedure [UpdateD04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateD04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateD04_SubContinent]
GO

CREATE PROCEDURE [UpdateD04_SubContinent]
    @SubContinent_ID int,
    @SubContinent_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteD04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteD04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteD04_SubContinent]
GO

CREATE PROCEDURE [DeleteD04_SubContinent]
    @SubContinent_ID int
AS
    BEGIN
