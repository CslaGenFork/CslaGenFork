/****** Object:  StoredProcedure [AddA05_SubContinent_ReChild] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddA05_SubContinent_ReChild]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddA05_SubContinent_ReChild]
GO
...
/****** Object:  StoredProcedure [UpdateA05_SubContinent_ReChild] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateA05_SubContinent_ReChild]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateA05_SubContinent_ReChild]
GO
...
/****** Object:  StoredProcedure [DeleteA05_SubContinent_ReChild] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteA05_SubContinent_ReChild]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteA05_SubContinent_ReChild]
GO
