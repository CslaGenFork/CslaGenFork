/****** Object:  StoredProcedure [AddH02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddH02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddH02_Continent]
GO

CREATE PROCEDURE [AddH02_Continent]
...
/****** Object:  StoredProcedure [UpdateH02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateH02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateH02_Continent]
GO

CREATE PROCEDURE [UpdateH02_Continent]
    @Continent_ID int,
    @Continent_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteH02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteH02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteH02_Continent]
GO

CREATE PROCEDURE [DeleteH02_Continent]
    @Continent_ID int
AS
    BEGIN
