/****** Object:  StoredProcedure [AddB02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddB02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddB02_Continent]
GO

CREATE PROCEDURE [AddB02_Continent]
...
/****** Object:  StoredProcedure [UpdateB02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateB02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateB02_Continent]
GO

CREATE PROCEDURE [UpdateB02_Continent]
    @Continent_ID int,
    @Continent_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteB02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteB02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteB02_Continent]
GO

CREATE PROCEDURE [DeleteB02_Continent]
    @Continent_ID int
AS
    BEGIN
