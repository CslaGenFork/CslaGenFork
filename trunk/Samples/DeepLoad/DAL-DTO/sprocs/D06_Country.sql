/****** Object:  StoredProcedure [AddD06_Country] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddD06_Country]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddD06_Country]
GO

CREATE PROCEDURE [AddD06_Country]
...
/****** Object:  StoredProcedure [UpdateD06_Country] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateD06_Country]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateD06_Country]
GO

CREATE PROCEDURE [UpdateD06_Country]
    @Country_ID int,
    @Country_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteD06_Country] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteD06_Country]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteD06_Country]
GO

CREATE PROCEDURE [DeleteD06_Country]
    @Country_ID int
AS
    BEGIN
