/****** Object:  StoredProcedure [GetC02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[GetC02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [GetC02_Continent]
GO

CREATE PROCEDURE [GetC02_Continent]
    @Continent_ID int
AS
    BEGIN
...
/****** Object:  StoredProcedure [AddC02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddC02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddC02_Continent]
GO

CREATE PROCEDURE [AddC02_Continent]
...
/****** Object:  StoredProcedure [UpdateC02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateC02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateC02_Continent]
GO

CREATE PROCEDURE [UpdateC02_Continent]
    @Continent_ID int,
    @Continent_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteC02_Continent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteC02_Continent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteC02_Continent]
GO

CREATE PROCEDURE [DeleteC02_Continent]
    @Continent_ID int
AS
    BEGIN
