...
namespace SelfLoadROSoftDelete.Business.ERLevel
{
    ...
    public partial class G05_SubContinent_ReChild : ReadOnlyBase<G05_SubContinent_ReChild>
    {
        ...
        /// <summary>
        /// Loads a <see cref="G05_SubContinent_ReChild"/> object from the given <see cref="G05_SubContinent_ReChildDto"/>.
        /// </summary>
        /// <param name="data">The G05_SubContinent_ReChildDto to use.</param>
        private void Fetch(G05_SubContinent_ReChildDto data)
        {
            // Value properties
