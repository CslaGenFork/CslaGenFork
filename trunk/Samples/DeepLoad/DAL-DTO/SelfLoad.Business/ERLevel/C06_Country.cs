...
{
    public partial class C06_Country
    {
        ...
        protected override void OnChildChanged(Csla.Core.ChildChangedEventArgs e)
        {
            ...
            //PropertyHasChanged(C07_Country_SingleObjectProperty);
            //PropertyHasChanged(C07_Country_ASingleObjectProperty);
            //PropertyHasChanged(C07_RegionObjectsProperty);
