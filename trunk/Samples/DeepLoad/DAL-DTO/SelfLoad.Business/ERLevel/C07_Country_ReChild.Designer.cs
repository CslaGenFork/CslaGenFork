...
namespace SelfLoad.Business.ERLevel
{
    ...
    /// <summary>
    /// C07_Country_ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class C07_Country_ReChild : BusinessBase<C07_Country_ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="C07_Country_ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="C07_Country_ReChild"/> object.</returns>
        internal static C07_Country_ReChild NewC07_Country_ReChild()
        {
            return DataPortal.CreateChild<C07_Country_ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="C07_Country_ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="C07_Country_ReChild"/> object in the database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Insert(C06_Country parent)
        {
            var dto = new C07_Country_ReChildDto();
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="C07_Country_ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        ...
        /// <summary>
        /// Self deletes the <see cref="C07_Country_ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
