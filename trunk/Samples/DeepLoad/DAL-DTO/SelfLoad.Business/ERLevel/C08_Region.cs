...
{
    public partial class C08_Region
    {
        ...
        protected override void OnChildChanged(Csla.Core.ChildChangedEventArgs e)
        {
            ...
            //PropertyHasChanged(C09_Region_SingleObjectProperty);
            //PropertyHasChanged(C09_Region_ASingleObjectProperty);
            //PropertyHasChanged(C09_CityObjectsProperty);
