...
{
    public partial class C02_Continent
    {
        ...
        protected override void OnChildChanged(Csla.Core.ChildChangedEventArgs e)
        {
            ...
            //PropertyHasChanged(C03_Continent_SingleObjectProperty);
            //PropertyHasChanged(C03_Continent_ASingleObjectProperty);
            //PropertyHasChanged(C03_SubContinentObjectsProperty);
