...
namespace SelfLoad.Business.ERCLevel
{
    ...
    public partial class D03_SubContinentColl : BusinessListBase<D03_SubContinentColl, D04_SubContinent>
    {
        ...
        /// <summary>
        /// Loads all <see cref="D03_SubContinentColl"/> collection items from the given list of D04_SubContinentDto.
        /// </summary>
        /// <param name="data">The list of <see cref="D04_SubContinentDto"/>.</param>
        private void Fetch(List<D04_SubContinentDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            foreach (var dto in data)
            {
                Add(D04_SubContinent.GetD04_SubContinent(dto));
            }
            RaiseListChangedEvents = rlce;
        }
