...
namespace ParentLoadROSoftDelete.Business.ERLevel
{
    ...
    public partial class E05_CountryColl : ReadOnlyListBase<E05_CountryColl, E06_Country>
    {
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="E05_CountryColl"/> object from the given list of E06_CountryDto.
        /// </summary>
        /// <param name="data">The list of <see cref="E06_CountryDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="E05_CountryColl"/> object.</returns>
        internal static E05_CountryColl GetE05_CountryColl(List<E06_CountryDto> data)
        {
        ...
        /// <summary>
        /// Loads all <see cref="E05_CountryColl"/> collection items from the given list of E06_CountryDto.
        /// </summary>
        /// <param name="data">The list of <see cref="E06_CountryDto"/>.</param>
        private void Fetch(List<E06_CountryDto> data)
        {
            IsReadOnly = false;
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(E06_Country.GetE06_Country(dto));
            }
            OnFetchPost(args);
            RaiseListChangedEvents = rlce;
            IsReadOnly = true;
