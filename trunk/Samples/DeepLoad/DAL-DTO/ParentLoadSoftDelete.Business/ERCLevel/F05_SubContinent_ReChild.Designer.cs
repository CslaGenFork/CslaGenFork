...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// F05_SubContinent_ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class F05_SubContinent_ReChild : BusinessBase<F05_SubContinent_ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="F05_SubContinent_ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="F05_SubContinent_ReChild"/> object.</returns>
        internal static F05_SubContinent_ReChild NewF05_SubContinent_ReChild()
        {
            return DataPortal.CreateChild<F05_SubContinent_ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="F05_SubContinent_ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="F05_SubContinent_ReChild"/> object in the database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Insert(F04_SubContinent parent)
        {
            var dto = new F05_SubContinent_ReChildDto();
            ...
            using (var dalManager = DalFactoryParentLoadSoftDelete.GetManager())
            {
                ...
                OnInsertPre(args);
                var dal = dalManager.GetProvider<IF05_SubContinent_ReChildDal>();
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="F05_SubContinent_ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        ...
        /// <summary>
        /// Self deletes the <see cref="F05_SubContinent_ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
