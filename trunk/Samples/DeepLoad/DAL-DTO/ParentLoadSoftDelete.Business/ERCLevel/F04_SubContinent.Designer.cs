...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    public partial class F04_SubContinent : BusinessBase<F04_SubContinent>
    {
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="F04_SubContinent"/> object from the given F04_SubContinentDto.
        /// </summary>
        /// <param name="data">The <see cref="F04_SubContinentDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="F04_SubContinent"/> object.</returns>
        internal static F04_SubContinent GetF04_SubContinent(F04_SubContinentDto data)
        {
        ...
        /// <summary>
        /// Loads a <see cref="F04_SubContinent"/> object from the given <see cref="F04_SubContinentDto"/>.
        /// </summary>
        /// <param name="data">The F04_SubContinentDto to use.</param>
        private void Fetch(F04_SubContinentDto data)
        {
            // Value properties
        ...
        {
            var dto = new F04_SubContinentDto();
            ...
            using (var dalManager = DalFactoryParentLoadSoftDelete.GetManager())
            {
                ...
                OnInsertPre(args);
                var dal = dalManager.GetProvider<IF04_SubContinentDal>();
