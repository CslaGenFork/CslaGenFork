...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// F05_CountryColl (editable child list).<br/>
    /// This is a generated base class of <see cref="F05_CountryColl"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is child of <see cref="F04_SubContinent"/> editable child object.<br/>
    /// The items of the collection are <see cref="F06_Country"/> objects.
    /// </remarks>
    [Serializable]
    public partial class F05_CountryColl : BusinessListBase<F05_CountryColl, F06_Country>
    {

        #region Collection Business Methods

        /// <summary>
        /// Removes a <see cref="F06_Country"/> item from the collection.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether a <see cref="F06_Country"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="country_ID">The Country_ID of the item to search for.</param>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="F05_CountryColl"/> collection.
        /// </summary>
        /// <returns>A reference to the created <see cref="F05_CountryColl"/> collection.</returns>
        internal static F05_CountryColl NewF05_CountryColl()
        {
            return DataPortal.CreateChild<F05_CountryColl>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="F05_CountryColl"/> object from the given list of F06_CountryDto.
        /// </summary>
        /// <param name="data">The list of <see cref="F06_CountryDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="F05_CountryColl"/> object.</returns>
        internal static F05_CountryColl GetF05_CountryColl(List<F06_CountryDto> data)
        {
        ...
        /// <summary>
        /// Loads all <see cref="F05_CountryColl"/> collection items from the given list of F06_CountryDto.
        /// </summary>
        /// <param name="data">The list of <see cref="F06_CountryDto"/>.</param>
        private void Fetch(List<F06_CountryDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(F06_Country.GetF06_Country(dto));
            }
            OnFetchPost(args);
            RaiseListChangedEvents = rlce;
        }
