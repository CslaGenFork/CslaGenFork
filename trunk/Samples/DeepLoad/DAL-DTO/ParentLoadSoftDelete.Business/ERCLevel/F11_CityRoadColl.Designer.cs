...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    public partial class F11_CityRoadColl : BusinessListBase<F11_CityRoadColl, F12_CityRoad>
    {
        ...
        {
            foreach (var f12_CityRoad in DeletedList)
            {
                if (f12_CityRoad.CityRoad_ID == cityRoad_ID)
                {
                    return true;
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="F11_CityRoadColl"/> object from the given list of F12_CityRoadDto.
        /// </summary>
        /// <param name="data">The list of <see cref="F12_CityRoadDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="F11_CityRoadColl"/> object.</returns>
        internal static F11_CityRoadColl GetF11_CityRoadColl(List<F12_CityRoadDto> data)
        {
        ...
        /// <summary>
        /// Loads all <see cref="F11_CityRoadColl"/> collection items from the given list of F12_CityRoadDto.
        /// </summary>
        /// <param name="data">The list of <see cref="F12_CityRoadDto"/>.</param>
        private void Fetch(List<F12_CityRoadDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(F12_CityRoad.GetF12_CityRoad(dto));
            }
            OnFetchPost(args);
            RaiseListChangedEvents = rlce;
        }
