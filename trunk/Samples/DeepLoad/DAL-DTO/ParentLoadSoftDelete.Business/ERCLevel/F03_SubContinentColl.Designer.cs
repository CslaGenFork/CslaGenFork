...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    public partial class F03_SubContinentColl : BusinessListBase<F03_SubContinentColl, F04_SubContinent>
    {
        ...
        {
            foreach (var f04_SubContinent in this.DeletedList)
            {
                if (f04_SubContinent.SubContinent_ID == subContinent_ID)
                {
                    return true;
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="F03_SubContinentColl"/> object from the given list of F04_SubContinentDto.
        /// </summary>
        /// <param name="data">The list of <see cref="F04_SubContinentDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="F03_SubContinentColl"/> object.</returns>
        internal static F03_SubContinentColl GetF03_SubContinentColl(List<F04_SubContinentDto> data)
        {
        ...
        /// <summary>
        /// Loads all <see cref="F03_SubContinentColl"/> collection items from the given list of F04_SubContinentDto.
        /// </summary>
        /// <param name="data">The list of <see cref="F04_SubContinentDto"/>.</param>
        private void Fetch(List<F04_SubContinentDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(F04_SubContinent.GetF04_SubContinent(dto));
            }
            OnFetchPost(args);
            RaiseListChangedEvents = rlce;
        }
