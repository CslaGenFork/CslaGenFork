...
namespace ParentLoadSoftDelete.Business.ERLevel
{
    ...
    public partial class E09_CityColl : BusinessListBase<E09_CityColl, E10_City>
    {
        ...
        {
            foreach (var e10_City in this.DeletedList)
            {
                if (e10_City.City_ID == city_ID)
                {
                    return true;
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="E09_CityColl"/> object from the given list of E10_CityDto.
        /// </summary>
        /// <param name="data">The list of <see cref="E10_CityDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="E09_CityColl"/> object.</returns>
        internal static E09_CityColl GetE09_CityColl(List<E10_CityDto> data)
        {
        ...
        /// <summary>
        /// Loads all <see cref="E09_CityColl"/> collection items from the given list of E10_CityDto.
        /// </summary>
        /// <param name="data">The list of <see cref="E10_CityDto"/>.</param>
        private void Fetch(List<E10_CityDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
