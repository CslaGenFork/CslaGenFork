...
namespace ParentLoadSoftDelete.Business.ERLevel
{
    ...
    public partial class E11_CityRoadColl : BusinessListBase<E11_CityRoadColl, E12_CityRoad>
    {
        ...
        {
            foreach (var e12_CityRoad in this.DeletedList)
            {
                if (e12_CityRoad.CityRoad_ID == cityRoad_ID)
                {
                    return true;
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="E11_CityRoadColl"/> object from the given list of E12_CityRoadDto.
        /// </summary>
        /// <param name="data">The list of <see cref="E12_CityRoadDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="E11_CityRoadColl"/> object.</returns>
        internal static E11_CityRoadColl GetE11_CityRoadColl(List<E12_CityRoadDto> data)
        {
        ...
        /// <summary>
        /// Loads all <see cref="E11_CityRoadColl"/> collection items from the given list of E12_CityRoadDto.
        /// </summary>
        /// <param name="data">The list of <see cref="E12_CityRoadDto"/>.</param>
        private void Fetch(List<E12_CityRoadDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(E12_CityRoad.GetE12_CityRoad(dto));
            }
            OnFetchPost(args);
            RaiseListChangedEvents = rlce;
        }
