...
namespace ParentLoadSoftDelete.Business.ERLevel
{
    ...
    /// <summary>
    /// E11_City_Child (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class E11_City_Child : BusinessBase<E11_City_Child>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="E11_City_Child"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="E11_City_Child"/> object.</returns>
        internal static E11_City_Child NewE11_City_Child()
        {
            return DataPortal.CreateChild<E11_City_Child>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="E11_City_Child"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="E11_City_Child"/> object in the database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Insert(E10_City parent)
        {
            var dto = new E11_City_ChildDto();
            ...
            using (var dalManager = DalFactoryParentLoadSoftDelete.GetManager())
            {
                ...
                OnInsertPre(args);
                var dal = dalManager.GetProvider<IE11_City_ChildDal>();
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="E11_City_Child"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        ...
        /// <summary>
        /// Self deletes the <see cref="E11_City_Child"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
