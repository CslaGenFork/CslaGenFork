...
namespace ParentLoadSoftDelete.Business.ERLevel
{
    public partial class E10_City
    {
        ...
        protected override void OnChildChanged(Csla.Core.ChildChangedEventArgs e)
        {
            ...
            //PropertyHasChanged(E11_City_SingleObjectProperty);
            //PropertyHasChanged(E11_City_ASingleObjectProperty);
            //PropertyHasChanged(E11_CityRoadObjectsProperty);
