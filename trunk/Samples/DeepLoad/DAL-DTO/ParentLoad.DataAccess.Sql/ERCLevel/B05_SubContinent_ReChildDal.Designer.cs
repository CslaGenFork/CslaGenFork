...
namespace ParentLoad.DataAccess.Sql.ERCLevel
{
    ...
    public partial class B05_SubContinent_ReChildDal : IB05_SubContinent_ReChildDal
    {
        ...
        public B05_SubContinent_ReChildDto Insert(B05_SubContinent_ReChildDto b05_SubContinent_ReChild)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddB05_SubContinent_ReChild", ctx.Connection))
                {
                    ...
                    cmd.Parameters.AddWithValue("@SubContinent_ID2", b05_SubContinent_ReChild.Parent_SubContinent_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@SubContinent_Child_Name", b05_SubContinent_ReChild.SubContinent_Child_Name).DbType = DbType.String;
                    cmd.ExecuteNonQuery();
                }
            }
        ...
        public B05_SubContinent_ReChildDto Update(B05_SubContinent_ReChildDto b05_SubContinent_ReChild)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
