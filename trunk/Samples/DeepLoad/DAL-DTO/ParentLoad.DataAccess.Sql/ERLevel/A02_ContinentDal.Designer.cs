...
namespace ParentLoad.DataAccess.Sql.ERLevel
{
    ...
    public partial class A02_ContinentDal : IA02_ContinentDal
    {
        ...
        /// </summary>
        /// <param name="a02_Continent">The A02 Continent DTO.</param>
        /// <returns>The new <see cref="A02_ContinentDto"/>.</returns>
        public A02_ContinentDto Insert(A02_ContinentDto a02_Continent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Continent_ID", a02_Continent.Continent_ID).Direction = ParameterDirection.Output;
                    cmd.Parameters.AddWithValue("@Continent_Name", a02_Continent.Continent_Name).DbType = DbType.String;
                    cmd.ExecuteNonQuery();
                    a02_Continent.Continent_ID = (int)cmd.Parameters["@Continent_ID"].Value;
                }
            }
            return a02_Continent;
        }
        ...
        /// </summary>
        /// <param name="a02_Continent">The A02 Continent DTO.</param>
        /// <returns>The updated <see cref="A02_ContinentDto"/>.</returns>
        public A02_ContinentDto Update(A02_ContinentDto a02_Continent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Continent_ID", a02_Continent.Continent_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Continent_Name", a02_Continent.Continent_Name).DbType = DbType.String;
