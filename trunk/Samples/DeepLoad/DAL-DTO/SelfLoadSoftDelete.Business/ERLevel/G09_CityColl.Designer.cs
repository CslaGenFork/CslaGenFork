...
namespace SelfLoadSoftDelete.Business.ERLevel
{
    ...
    public partial class G09_CityColl : BusinessListBase<G09_CityColl, G10_City>
    {
        ...
        /// <summary>
        /// Loads all <see cref="G09_CityColl"/> collection items from the given list of G10_CityDto.
        /// </summary>
        /// <param name="data">The list of <see cref="G10_CityDto"/>.</param>
        private void Fetch(List<G10_CityDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            foreach (var dto in data)
            {
                Add(G10_City.GetG10_City(dto));
            }
            RaiseListChangedEvents = rlce;
        }
