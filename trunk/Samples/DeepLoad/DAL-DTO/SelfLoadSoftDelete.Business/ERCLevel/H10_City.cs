...
namespace SelfLoadSoftDelete.Business.ERCLevel
{
    public partial class H10_City
    {
        ...
        protected override void OnChildChanged(Csla.Core.ChildChangedEventArgs e)
        {
            ...
            //PropertyHasChanged(H11_City_SingleObjectProperty);
            //PropertyHasChanged(H11_City_ASingleObjectProperty);
            //PropertyHasChanged(H11_CityRoadObjectsProperty);
