...
namespace SelfLoadSoftDelete.Business.ERCLevel
{
    ...
    public partial class H09_CityColl : BusinessListBase<H09_CityColl, H10_City>
    {
        ...
        /// <summary>
        /// Loads all <see cref="H09_CityColl"/> collection items from the given list of H10_CityDto.
        /// </summary>
        /// <param name="data">The list of <see cref="H10_CityDto"/>.</param>
        private void Fetch(List<H10_CityDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            foreach (var dto in data)
            {
                Add(H10_City.GetH10_City(dto));
            }
            RaiseListChangedEvents = rlce;
        }
