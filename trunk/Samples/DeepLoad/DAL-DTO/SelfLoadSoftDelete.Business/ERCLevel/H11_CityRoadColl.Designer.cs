...
namespace SelfLoadSoftDelete.Business.ERCLevel
{
    ...
    public partial class H11_CityRoadColl : BusinessListBase<H11_CityRoadColl, H12_CityRoad>
    {
        ...
        {
            foreach (var h12_CityRoad in DeletedList)
            {
                if (h12_CityRoad.CityRoad_ID == cityRoad_ID)
                {
                    return true;
        ...
        /// <summary>
        /// Finds a <see cref="H12_CityRoad"/> item of the <see cref="H11_CityRoadColl"/> collection, based on a given CityRoad_ID.
        /// </summary>
        /// <param name="cityRoad_ID">The CityRoad_ID.</param>
        /// <returns>A <see cref="H12_CityRoad"/> object.</returns>
        public H12_CityRoad FindH12_CityRoadByCityRoad_ID(int cityRoad_ID)
        {
        ...
        /// <summary>
        /// Loads all <see cref="H11_CityRoadColl"/> collection items from the given list of H12_CityRoadDto.
        /// </summary>
        /// <param name="data">The list of <see cref="H12_CityRoadDto"/>.</param>
        private void Fetch(List<H12_CityRoadDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            foreach (var dto in data)
            {
                Add(H12_CityRoad.GetH12_CityRoad(dto));
            }
            RaiseListChangedEvents = rlce;
        }
