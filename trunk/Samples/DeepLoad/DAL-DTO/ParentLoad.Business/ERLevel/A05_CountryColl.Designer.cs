...
namespace ParentLoad.Business.ERLevel
{
    ...
    public partial class A05_CountryColl : BusinessListBase<A05_CountryColl, A06_Country>
    {
        ...
        {
            foreach (var a06_Country in this.DeletedList)
            {
                if (a06_Country.Country_ID == country_ID)
                {
                    return true;
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="A05_CountryColl"/> object from the given list of A06_CountryDto.
        /// </summary>
        /// <param name="data">The list of <see cref="A06_CountryDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="A05_CountryColl"/> object.</returns>
        internal static A05_CountryColl GetA05_CountryColl(List<A06_CountryDto> data)
        {
        ...
        /// <summary>
        /// Loads all <see cref="A05_CountryColl"/> collection items from the given list of A06_CountryDto.
        /// </summary>
        /// <param name="data">The list of <see cref="A06_CountryDto"/>.</param>
        private void Fetch(List<A06_CountryDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(A06_Country.GetA06_Country(dto));
            }
            OnFetchPost(args);
            RaiseListChangedEvents = rlce;
        }
