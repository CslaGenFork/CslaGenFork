...
namespace ParentLoad.Business.ERLevel
{
    ...
    public partial class A03_SubContinentColl : BusinessListBase<A03_SubContinentColl, A04_SubContinent>
    {
        ...
        {
            foreach (var a04_SubContinent in this.DeletedList)
            {
                if (a04_SubContinent.SubContinent_ID == subContinent_ID)
                {
                    return true;
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="A03_SubContinentColl"/> object from the given list of A04_SubContinentDto.
        /// </summary>
        /// <param name="data">The list of <see cref="A04_SubContinentDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="A03_SubContinentColl"/> object.</returns>
        internal static A03_SubContinentColl GetA03_SubContinentColl(List<A04_SubContinentDto> data)
        {
        ...
        /// <summary>
        /// Loads all <see cref="A03_SubContinentColl"/> collection items from the given list of A04_SubContinentDto.
        /// </summary>
        /// <param name="data">The list of <see cref="A04_SubContinentDto"/>.</param>
        private void Fetch(List<A04_SubContinentDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(A04_SubContinent.GetA04_SubContinent(dto));
            }
            OnFetchPost(args);
            RaiseListChangedEvents = rlce;
        }
