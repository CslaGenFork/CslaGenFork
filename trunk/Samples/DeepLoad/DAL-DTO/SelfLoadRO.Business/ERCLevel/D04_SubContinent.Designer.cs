...
namespace SelfLoadRO.Business.ERCLevel
{
    ...
    public partial class D04_SubContinent : ReadOnlyBase<D04_SubContinent>
    {
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="D04_SubContinent"/> object from the given D04_SubContinentDto.
        /// </summary>
        /// <param name="data">The <see cref="D04_SubContinentDto"/>.</param>
        /// <returns>A reference to the fetched <see cref="D04_SubContinent"/> object.</returns>
        internal static D04_SubContinent GetD04_SubContinent(D04_SubContinentDto data)
        {
        ...
        /// <summary>
        /// Loads a <see cref="D04_SubContinent"/> object from the given <see cref="D04_SubContinentDto"/>.
        /// </summary>
        /// <param name="data">The D04_SubContinentDto to use.</param>
        private void Fetch(D04_SubContinentDto data)
        {
            // Value properties
