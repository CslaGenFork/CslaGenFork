...
namespace SelfLoadRO.Business.ERCLevel
{
    ...
    /// <summary>
    /// D09_Region_ReChild (read only object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class D09_Region_ReChild : ReadOnlyBase<D09_Region_ReChild>
    {
        ...
        /// <summary>
        /// Loads a <see cref="D09_Region_ReChild"/> object from the given <see cref="D09_Region_ReChildDto"/>.
        /// </summary>
        /// <param name="data">The D09_Region_ReChildDto to use.</param>
        private void Fetch(D09_Region_ReChildDto data)
        {
            // Value properties
