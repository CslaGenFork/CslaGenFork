...
namespace ParentLoadRO.Business.ERCLevel
{
    ...
    /// <summary>
    /// B04Level11 (read only object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class B04Level11 : ReadOnlyBase<B04Level11>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<B05Level111ReChild> B05Level111ASingleObjectProperty = RegisterProperty<B05Level111ReChild>(p => p.B05Level111ASingleObject, "B5 Level111 ASingle Object");
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<B05Level111Child> B05Level111SingleObjectProperty = RegisterProperty<B05Level111Child>(p => p.B05Level111SingleObject, "B5 Level111 Single Object");
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<B05Level111Coll> B05Level111ObjectsProperty = RegisterProperty<B05Level111Coll>(p => p.B05Level111Objects, "B5 Level111 Objects");
        /// <summary>
        ...
        internal static B04Level11 GetB04Level11(SafeDataReader dr)
        {
            ...
            obj.Fetch(dr);
            obj.LoadProperty(B05Level111ObjectsProperty, new B05Level111Coll());
            return obj;
        }
