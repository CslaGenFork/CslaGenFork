...
namespace ParentLoad.Business.ERCLevel
{
    public partial class B10_City
    {
        ...
        protected override void OnChildChanged(Csla.Core.ChildChangedEventArgs e)
        {
            ...
            //PropertyHasChanged(B11_City_SingleObjectProperty);
            //PropertyHasChanged(B11_City_ASingleObjectProperty);
            //PropertyHasChanged(B11_CityRoadObjectsProperty);
