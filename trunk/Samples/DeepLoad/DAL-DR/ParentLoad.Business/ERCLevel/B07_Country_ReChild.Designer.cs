...
namespace ParentLoad.Business.ERCLevel
{
    ...
    /// <summary>
    /// B07_Country_ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class B07_Country_ReChild : BusinessBase<B07_Country_ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="B07_Country_ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="B07_Country_ReChild"/> object.</returns>
        internal static B07_Country_ReChild NewB07_Country_ReChild()
        {
            return DataPortal.CreateChild<B07_Country_ReChild>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="B07_Country_ReChild"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        /// <returns>A reference to the fetched <see cref="B07_Country_ReChild"/> object.</returns>
        internal static B07_Country_ReChild GetB07_Country_ReChild(SafeDataReader dr)
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="B07_Country_ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="B07_Country_ReChild"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        ...
        /// <summary>
        /// Inserts a new <see cref="B07_Country_ReChild"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(B06_Country parent)
        {
            using (var dalManager = DalFactoryParentLoad.GetManager())
            {
                var args = new DataPortalHookArgs();
                OnInsertPre(args);
                var dal = dalManager.GetProvider<IB07_Country_ReChildDal>();
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="B07_Country_ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        ...
        /// <summary>
        /// Self deletes the <see cref="B07_Country_ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
