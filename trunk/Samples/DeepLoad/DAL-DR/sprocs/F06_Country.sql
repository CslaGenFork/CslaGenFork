...
/****** Object:  StoredProcedure [UpdateF06_Country] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateF06_Country]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateF06_Country]
GO

CREATE PROCEDURE [UpdateF06_Country]
    @Country_ID int,
    @Country_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteF06_Country] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteF06_Country]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteF06_Country]
GO

CREATE PROCEDURE [DeleteF06_Country]
    @Country_ID int
AS
    BEGIN
