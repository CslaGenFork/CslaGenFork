/****** Object:  StoredProcedure [AddA06_Country] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddA06_Country]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddA06_Country]
GO
...
/****** Object:  StoredProcedure [UpdateA06_Country] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateA06_Country]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateA06_Country]
GO

CREATE PROCEDURE [UpdateA06_Country]
    @Country_ID int,
    @Country_Name varchar(50),
    @Parent_SubContinent_ID int,
...
/****** Object:  StoredProcedure [DeleteA06_Country] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteA06_Country]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteA06_Country]
GO

CREATE PROCEDURE [DeleteA06_Country]
    @Country_ID int
AS
    BEGIN
