/****** Object:  StoredProcedure [AddE04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[AddE04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [AddE04_SubContinent]
GO
...
/****** Object:  StoredProcedure [UpdateE04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[UpdateE04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [UpdateE04_SubContinent]
GO

CREATE PROCEDURE [UpdateE04_SubContinent]
    @SubContinent_ID int,
    @SubContinent_Name varchar(50)
AS
    BEGIN
...
/****** Object:  StoredProcedure [DeleteE04_SubContinent] ******/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[DeleteE04_SubContinent]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [DeleteE04_SubContinent]
GO

CREATE PROCEDURE [DeleteE04_SubContinent]
    @SubContinent_ID int
AS
    BEGIN
