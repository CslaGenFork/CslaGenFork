...
namespace ParentLoadSoftDelete.Business.ERLevel
{
    public partial class E04_SubContinent
    {
        ...
        protected override void OnChildChanged(Csla.Core.ChildChangedEventArgs e)
        {
            ...
            //PropertyHasChanged(E05_SubContinent_SingleObjectProperty);
            //PropertyHasChanged(E05_SubContinent_ASingleObjectProperty);
            //PropertyHasChanged(E05_CountryObjectsProperty);
