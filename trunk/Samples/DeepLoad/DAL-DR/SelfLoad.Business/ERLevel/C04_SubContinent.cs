...
{
    public partial class C04_SubContinent
    {
        ...
        protected override void OnChildChanged(Csla.Core.ChildChangedEventArgs e)
        {
            ...
            //PropertyHasChanged(C05_SubContinent_SingleObjectProperty);
            //PropertyHasChanged(C05_SubContinent_ASingleObjectProperty);
            //PropertyHasChanged(C05_CountryObjectsProperty);
