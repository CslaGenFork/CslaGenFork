...
namespace ParentLoadRO.Business.ERCLevel
{
    ...
    public partial class B11_CityRoadColl : ReadOnlyListBase<B11_CityRoadColl, B12_CityRoad>
    {
        ...
        /// <summary>
        /// Factory method. Loads a <see cref="B11_CityRoadColl"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        /// <returns>A reference to the fetched <see cref="B11_CityRoadColl"/> object.</returns>
        internal static B11_CityRoadColl GetB11_CityRoadColl(SafeDataReader dr)
        {
        ...
        /// <summary>
        /// Loads all <see cref="B11_CityRoadColl"/> collection items from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        private void Fetch(SafeDataReader dr)
        {
            ...
            while (dr.Read())
            {
                Add(B12_CityRoad.GetB12_CityRoad(dr));
            }
            OnFetchPost(args);
            RaiseListChangedEvents = rlce;
            IsReadOnly = true;
