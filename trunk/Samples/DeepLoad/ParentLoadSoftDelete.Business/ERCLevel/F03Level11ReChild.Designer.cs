...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// F03Level11ReChild (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class F03Level11ReChild : BusinessBase<F03Level11ReChild>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="F03Level11ReChild"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="F03Level11ReChild"/> object.</returns>
        internal static F03Level11ReChild NewF03Level11ReChild()
        {
            return DataPortal.CreateChild<F03Level11ReChild>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="F03Level11ReChild"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="F03Level11ReChild"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(F02Level1 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddF03Level11ReChild", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="F03Level11ReChild"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(F02Level1 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateF03Level11ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_ID", parent.Level_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_Child_Name", ReadProperty(Level_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="F03Level11ReChild"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(F02Level1 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteF03Level11ReChild", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_ID", parent.Level_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
