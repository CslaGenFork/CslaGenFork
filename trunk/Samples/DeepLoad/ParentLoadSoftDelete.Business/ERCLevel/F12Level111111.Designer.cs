...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// F12Level111111 (editable child object).<br/>
    /// This is a generated base class of <see cref="F12Level111111"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="F11Level111111Coll"/> collection.
    /// </remarks>
    [Serializable]
    public partial class F12Level111111 : BusinessBase<F12Level111111>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="F12Level111111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="F12Level111111"/> object.</returns>
        internal static F12Level111111 NewF12Level111111()
        {
            return DataPortal.CreateChild<F12Level111111>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="F12Level111111"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        /// <returns>A reference to the fetched <see cref="F12Level111111"/> object.</returns>
        internal static F12Level111111 GetF12Level111111(SafeDataReader dr)
        {
            F12Level111111 obj = new F12Level111111();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="F12Level111111"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private F12Level111111()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="F12Level111111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="F12Level111111"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        ...
        /// <summary>
        /// Inserts a new <see cref="F12Level111111"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(F10Level11111 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddF12Level111111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="F12Level111111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateF12Level111111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="F12Level111111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteF12Level111111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_1_ID", ReadProperty(Level_1_1_1_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
