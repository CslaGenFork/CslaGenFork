...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// F08Level1111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class F08Level1111 : BusinessBase<F08Level1111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<F09Level11111Child> F09Level11111SingleObjectProperty = RegisterProperty<F09Level11111Child>(p => p.F09Level11111SingleObject, "F09 Level11111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<F09Level11111ReChild> F09Level11111ASingleObjectProperty = RegisterProperty<F09Level11111ReChild>(p => p.F09Level11111ASingleObject, "F09 Level11111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<F09Level11111Coll> F09Level11111ObjectsProperty = RegisterProperty<F09Level11111Coll>(p => p.F09Level11111Objects, "F09 Level11111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="F08Level1111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="F08Level1111"/> object.</returns>
        internal static F08Level1111 NewF08Level1111()
        {
            return DataPortal.CreateChild<F08Level1111>();
        }
        ...
        internal static F08Level1111 GetF08Level1111(SafeDataReader dr)
        {
            ...
            obj.MarkAsChild();
            obj.Fetch(dr);
            obj.LoadProperty(F09Level11111ObjectsProperty, F09Level11111Coll.NewF09Level11111Coll());
            obj.MarkOld();
            return obj;
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="F08Level1111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            LoadProperty(Level_1_1_1_1_IDProperty, System.Threading.Interlocked.Decrement(ref _lastID));
            LoadProperty(F09Level11111SingleObjectProperty, DataPortal.CreateChild<F09Level11111Child>());
            LoadProperty(F09Level11111ASingleObjectProperty, DataPortal.CreateChild<F09Level11111ReChild>());
            LoadProperty(F09Level11111ObjectsProperty, DataPortal.CreateChild<F09Level11111Coll>());
        ...
        /// <summary>
        /// Inserts a new <see cref="F08Level1111"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(F06Level111 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddF08Level1111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="F08Level1111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateF08Level1111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="F08Level1111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteF08Level1111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_ID", ReadProperty(Level_1_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
