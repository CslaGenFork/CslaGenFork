...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// F10Level11111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class F10Level11111 : BusinessBase<F10Level11111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<F11Level111111Child> F11Level111111SingleObjectProperty = RegisterProperty<F11Level111111Child>(p => p.F11Level111111SingleObject, "F11 Level111111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<F11Level111111ReChild> F11Level111111ASingleObjectProperty = RegisterProperty<F11Level111111ReChild>(p => p.F11Level111111ASingleObject, "F11 Level111111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<F11Level111111Coll> F11Level111111ObjectsProperty = RegisterProperty<F11Level111111Coll>(p => p.F11Level111111Objects, "F11 Level111111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="F10Level11111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="F10Level11111"/> object.</returns>
        internal static F10Level11111 NewF10Level11111()
        {
            return DataPortal.CreateChild<F10Level11111>();
        }
        ...
        internal static F10Level11111 GetF10Level11111(SafeDataReader dr)
        {
            ...
            obj.MarkAsChild();
            obj.Fetch(dr);
            obj.LoadProperty(F11Level111111ObjectsProperty, F11Level111111Coll.NewF11Level111111Coll());
            obj.MarkOld();
            return obj;
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="F10Level11111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            LoadProperty(Level_1_1_1_1_1_IDProperty, System.Threading.Interlocked.Decrement(ref _lastID));
            LoadProperty(F11Level111111SingleObjectProperty, DataPortal.CreateChild<F11Level111111Child>());
            LoadProperty(F11Level111111ASingleObjectProperty, DataPortal.CreateChild<F11Level111111ReChild>());
            LoadProperty(F11Level111111ObjectsProperty, DataPortal.CreateChild<F11Level111111Coll>());
        ...
        /// <summary>
        /// Inserts a new <see cref="F10Level11111"/> object in the database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Insert(F08Level1111 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddF10Level11111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="F10Level11111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateF10Level11111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="F10Level11111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteF10Level11111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_1_ID", ReadProperty(Level_1_1_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
