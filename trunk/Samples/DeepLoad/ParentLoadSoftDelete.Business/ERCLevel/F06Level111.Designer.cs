...
namespace ParentLoadSoftDelete.Business.ERCLevel
{
    ...
    /// <summary>
    /// F06Level111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class F06Level111 : BusinessBase<F06Level111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<F07Level1111Child> F07Level1111SingleObjectProperty = RegisterProperty<F07Level1111Child>(p => p.F07Level1111SingleObject, "B7 Level1111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<F07Level1111ReChild> F07Level1111ASingleObjectProperty = RegisterProperty<F07Level1111ReChild>(p => p.F07Level1111ASingleObject, "B7 Level1111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<F07Level1111Coll> F07Level1111ObjectsProperty = RegisterProperty<F07Level1111Coll>(p => p.F07Level1111Objects, "B7 Level1111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="F06Level111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="F06Level111"/> object.</returns>
        internal static F06Level111 NewF06Level111()
        {
            return DataPortal.CreateChild<F06Level111>();
        }
        ...
        internal static F06Level111 GetF06Level111(SafeDataReader dr)
        {
            ...
            obj.MarkAsChild();
            obj.Fetch(dr);
            obj.LoadProperty(F07Level1111ObjectsProperty, F07Level1111Coll.NewF07Level1111Coll());
            obj.MarkOld();
            return obj;
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="F06Level111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            LoadProperty(Level_1_1_1_IDProperty, System.Threading.Interlocked.Decrement(ref _lastID));
            LoadProperty(F07Level1111SingleObjectProperty, DataPortal.CreateChild<F07Level1111Child>());
            LoadProperty(F07Level1111ASingleObjectProperty, DataPortal.CreateChild<F07Level1111ReChild>());
            LoadProperty(F07Level1111ObjectsProperty, DataPortal.CreateChild<F07Level1111Coll>());
        ...
        /// <summary>
        /// Inserts a new <see cref="F06Level111"/> object in the database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Insert(F04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("AddF06Level111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="F06Level111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateF06Level111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="F06Level111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteF06Level111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_ID", ReadProperty(Level_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
