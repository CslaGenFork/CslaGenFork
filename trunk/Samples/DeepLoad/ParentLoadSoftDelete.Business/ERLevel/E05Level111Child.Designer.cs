...
namespace ParentLoadSoftDelete.Business.ERLevel
{
    ...
    /// <summary>
    /// E05Level111Child (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class E05Level111Child : BusinessBase<E05Level111Child>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="E05Level111Child"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="E05Level111Child"/> object.</returns>
        internal static E05Level111Child NewE05Level111Child()
        {
            return DataPortal.CreateChild<E05Level111Child>();
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="E05Level111Child"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="E05Level111Child"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(E04Level11 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddE05Level111Child", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="E05Level111Child"/> object.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update(E04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateE05Level111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", parent.Level_1_1_ID).DbType = DbType.Int32;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_Child_Name", ReadProperty(Level_1_1_1_Child_NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="E05Level111Child"/> object from database.
        /// </summary>
        /// <param name="parent">The parent object.</param>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf(E04Level11 parent)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("DeleteE05Level111Child", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_ID", parent.Level_1_1_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
