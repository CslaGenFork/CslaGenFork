...
namespace ParentLoadSoftDelete.Business.ERLevel
{
    ...
    /// <summary>
    /// E08Level1111 (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class E08Level1111 : BusinessBase<E08Level1111>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<E09Level11111Child> E09Level11111SingleObjectProperty = RegisterProperty<E09Level11111Child>(p => p.E09Level11111SingleObject, "E09 Level11111 Single Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<E09Level11111ReChild> E09Level11111ASingleObjectProperty = RegisterProperty<E09Level11111ReChild>(p => p.E09Level11111ASingleObject, "E09 Level11111 ASingle Object", RelationshipTypes.Child);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<E09Level11111Coll> E09Level11111ObjectsProperty = RegisterProperty<E09Level11111Coll>(p => p.E09Level11111Objects, "E09 Level11111 Objects", RelationshipTypes.Child);
        /// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="E08Level1111"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="E08Level1111"/> object.</returns>
        internal static E08Level1111 NewE08Level1111()
        {
            return DataPortal.CreateChild<E08Level1111>();
        }
        ...
        internal static E08Level1111 GetE08Level1111(SafeDataReader dr)
        {
            ...
            obj.MarkAsChild();
            obj.Fetch(dr);
            obj.LoadProperty(E09Level11111ObjectsProperty, E09Level11111Coll.NewE09Level11111Coll());
            obj.MarkOld();
            return obj;
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="E08Level1111"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            LoadProperty(Level_1_1_1_1_IDProperty, System.Threading.Interlocked.Decrement(ref _lastID));
            LoadProperty(E09Level11111SingleObjectProperty, DataPortal.CreateChild<E09Level11111Child>());
            LoadProperty(E09Level11111ASingleObjectProperty, DataPortal.CreateChild<E09Level11111ReChild>());
            LoadProperty(E09Level11111ObjectsProperty, DataPortal.CreateChild<E09Level11111Coll>());
        ...
        /// <summary>
        /// Inserts a new <see cref="E08Level1111"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(E06Level111 parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddE08Level1111", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="E08Level1111"/> object.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_Update()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                using (var cmd = new SqlCommand("UpdateE08Level1111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="E08Level1111"/> object from database.
        /// </summary>
        [Transactional(TransactionalTypes.TransactionScope)]
        private void Child_DeleteSelf()
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("DeepLoad"))
            {
                ...
                FieldManager.UpdateChildren(this);
                using (var cmd = new SqlCommand("DeleteE08Level1111", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Level_1_1_1_1_ID", ReadProperty(Level_1_1_1_1_IDProperty)).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd);
