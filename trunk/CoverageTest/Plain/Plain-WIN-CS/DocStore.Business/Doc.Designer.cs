...
namespace DocStore.Business
{
    ...
    public partial class Doc : BusinessBase<Doc>
    {
        ...
        protected override void DataPortal_Create()
        {
            ...
            LoadProperty(SecretProperty, null);
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(SecretProperty, dr.IsDBNull("Secret") ? null : dr.GetString("Secret"));
        ...
        protected override void DataPortal_Insert()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager(Database.DocStoreConnection, false))
            {
                using (var cmd = new SqlCommand("AddDoc", ctx.Connection))
                {
                    ...
                    cmd.Parameters.AddWithValue("@Secret", ReadProperty(SecretProperty) == null ? (object)DBNull.Value : ReadProperty(SecretProperty)).DbType = DbType.String;
