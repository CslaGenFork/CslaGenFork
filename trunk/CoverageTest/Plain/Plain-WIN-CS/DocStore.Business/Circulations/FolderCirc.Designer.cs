...
namespace DocStore.Business.Circulations
{
    ...
    /// </remarks>
    [Serializable]
    public partial class FolderCirc : BusinessBase<FolderCirc>
    {
        ...
        internal static FolderCirc NewFolderCirc()
        {
            return DataPortal.CreateChild<FolderCirc>();
        }
        ...
        internal static FolderCirc GetFolderCirc(SafeDataReader dr)
        {
            FolderCirc obj = new FolderCirc();
        ...
        internal static void NewFolderCirc(EventHandler<DataPortalResult<FolderCirc>> callback)
        {
            DataPortal.BeginCreate<FolderCirc>(callback);
        }
        ...
        {
            BusinessRules.AddRule(typeof (FolderCirc), new IsInRole(AuthorizationActions.GetObject, "User"));
        ...
        {
            return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.CreateObject, typeof(FolderCirc));
        }
        ...
        {
            return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.GetObject, typeof(FolderCirc));
        }
        ...
        {
            return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.EditObject, typeof(FolderCirc));
        }
        ...
        {
            return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.DeleteObject, typeof(FolderCirc));
        }
        ...
        private void Child_Insert(Folder parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("AddFolderCirc", ctx.Connection))
                {
        ...
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager(Database.DocStoreConnection, false))
            {
                using (var cmd = new SqlCommand("UpdateFolderCirc", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void Child_DeleteSelf()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager(Database.DocStoreConnection, false))
            {
                using (var cmd = new SqlCommand("DeleteFolderCirc", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@CircID", ReadProperty(CircIDProperty)).DbType = DbType.Int32;
