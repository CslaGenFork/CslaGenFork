...
Namespace DocStore.Business
    ...
    ''' </remarks>
    <Serializable()>
    Partial Public Class DocClassEdit
    Inherits BusinessBase(Of DocClassEdit)
        ...
        Friend Shared Function NewDocClassEdit() As DocClassEdit
            Return DataPortal.Create(Of DocClassEdit)()
        End Function
        ...
        Friend Shared Sub DeleteDocClassEdit(docClassID As Integer)
            DataPortal.Delete(Of DocClassEdit)(docClassID)
        End Sub
        ...
        ''' <param name="docClassID">The DocClassID of the DocClassEdit to delete.</param>
        ''' <param name="callback">The completion callback method.</param>
        Friend Shared Sub DeleteDocClassEdit(docClassID As Integer, callback As EventHandler(Of DataPortalResult(Of DocClassEdit)))
            DataPortal.BeginDelete(Of DocClassEdit)(docClassID, callback)
        End Sub
        ...
        Public Sub New()
            ...
            AddHandler Saved, AddressOf OnDocClassEditSaved
        End Sub
        ...
        Private Sub OnDocClassEditSaved(sender As Object, e As Csla.Core.SavedEventArgs)
        ...
        Protected Shared Sub AddObjectAuthorizationRules()
            BusinessRules.AddRule(GetType(DocClassEdit), New IsInRole(AuthorizationActions.CreateObject, "Admin"))
            BusinessRules.AddRule(GetType(DocClassEdit), New IsInRole(AuthorizationActions.GetObject, "User"))
            BusinessRules.AddRule(GetType(DocClassEdit), New IsInRole(AuthorizationActions.EditObject, "Admin"))
            BusinessRules.AddRule(GetType(DocClassEdit), New IsInRole(AuthorizationActions.DeleteObject, "Admin"))
        ...
        Public Overloads Shared Function CanAddObject() As Boolean
            Return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.CreateObject, GetType(DocClassEdit))
        End Function
        ...
        Public Overloads Shared Function CanGetObject() As Boolean
            Return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.GetObject, GetType(DocClassEdit))
        End Function
        ...
        Public Overloads Shared Function CanEditObject() As Boolean
            Return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.EditObject, GetType(DocClassEdit))
        End Function
        ...
        Public Overloads Shared Function CanDeleteObject() As Boolean
            Return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.DeleteObject, GetType(DocClassEdit))
        End Function
