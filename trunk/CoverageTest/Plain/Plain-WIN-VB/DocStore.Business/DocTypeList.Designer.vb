...
#Else
        Inherits ReadOnlyListBase(Of DocTypeList, DocTypeInfo)
#End If
        ...
        Public Shared Sub GetDocTypeList(ByVal callback As EventHandler(Of DataPortalResult(Of DocTypeList)))
            If _list Is Nothing Then
                DataPortal.BeginFetch(Of DocTypeList)(Sub(o, e)
                        _list = e.Object
                        callback(o, e)
                    End Sub)
            Else
                callback(Nothing, New DataPortalResult(Of DocTypeList)(_list, Nothing, Nothing))
            End If
        End Sub
        ...
        ''' <param name="docTypeName">The DocTypeName parameter of the DocTypeList to fetch.</param>
        ''' <param name="callback">The completion callback method.</param>
        Public Shared Sub GetDocTypeList(docTypeName As String, ByVal callback As EventHandler(Of DataPortalResult(Of DocTypeList)))
            DataPortal.BeginFetch(Of DocTypeList)(docTypeName, callback)
        End Sub
