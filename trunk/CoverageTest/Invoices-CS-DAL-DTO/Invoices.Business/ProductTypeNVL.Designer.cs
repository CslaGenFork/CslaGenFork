...
namespace Invoices.Business
{
    ...
    /// This is a generated <see cref="ProductTypeNVL"/> business object.
    /// </summary>
    [Serializable]
    public partial class ProductTypeNVL : NameValueListBase<int, string>
    {
        ...
        private void LoadCollection(List<ProductTypeNVLItemDto> data)
        {
            IsReadOnly = false;
            ...
            {
                Add(new NameValuePair(dto.ProductTypeId, dto.Name));
            }
