...
namespace Invoices.Business
{
    ...
    public partial class ProductTypeItem : BusinessBase<ProductTypeItem>
    {
        ...
        /// <summary>
        /// Loads a <see cref="ProductTypeItem"/> object from the given <see cref="ProductTypeItemDto"/>.
        /// </summary>
        /// <param name="data">The ProductTypeItemDto to use.</param>
        private void Child_Fetch(ProductTypeItemDto data)
        {
            // Value properties
