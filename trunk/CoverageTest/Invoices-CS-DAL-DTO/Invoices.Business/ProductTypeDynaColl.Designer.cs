...
namespace Invoices.Business
{
...
#endif
    {
        ...
        /// <summary>
        /// Loads all <see cref="ProductTypeDynaColl"/> collection items from the given list of ProductTypeDynaItemDto.
        /// </summary>
        /// <param name="data">The list of <see cref="ProductTypeDynaItemDto"/>.</param>
        private void Fetch(List<ProductTypeDynaItemDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            foreach (var dto in data)
            {
                Add(DataPortal.Fetch<ProductTypeDynaItem>(dto));
            }
            RaiseListChangedEvents = rlce;
        }
