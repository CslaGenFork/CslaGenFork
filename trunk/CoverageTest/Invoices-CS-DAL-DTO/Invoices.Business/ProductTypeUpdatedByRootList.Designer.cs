...
namespace Invoices.Business
{
    ...
    /// This is a generated <see cref="ProductTypeUpdatedByRootList"/> business object.
...
#endif
    {
        ...
        /// <summary>
        /// Loads all <see cref="ProductTypeUpdatedByRootList"/> collection items from the given list of ProductTypeUpdatedByRootInfoDto.
        /// </summary>
        /// <param name="data">The list of <see cref="ProductTypeUpdatedByRootInfoDto"/>.</param>
        private void Fetch(List<ProductTypeUpdatedByRootInfoDto> data)
        {
            IsReadOnly = false;
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(DataPortal.FetchChild<ProductTypeUpdatedByRootInfo>(dto));
            }
            RaiseListChangedEvents = rlce;
            IsReadOnly = true;
        }
