...
namespace Invoices.Business
{
...
#endif
    {
        ...
        /// <summary>
        /// Loads all <see cref="ProductTypeCachedList"/> collection items from the given list of ProductTypeCachedInfoDto.
        /// </summary>
        /// <param name="data">The list of <see cref="ProductTypeCachedInfoDto"/>.</param>
        private void Fetch(List<ProductTypeCachedInfoDto> data)
        {
            IsReadOnly = false;
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(DataPortal.FetchChild<ProductTypeCachedInfo>(dto));
            }
            RaiseListChangedEvents = rlce;
            IsReadOnly = true;
        }
