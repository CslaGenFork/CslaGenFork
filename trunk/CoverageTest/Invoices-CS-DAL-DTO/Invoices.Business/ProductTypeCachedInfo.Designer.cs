...
namespace Invoices.Business
{
    ...
    /// This is a generated <see cref="ProductTypeCachedInfo"/> business object.
    /// </summary>
    /// <remarks>
    ...
    public partial class ProductTypeCachedInfo : ReadOnlyBase<ProductTypeCachedInfo>
    {
        ...
        /// <summary>
        /// Loads a <see cref="ProductTypeCachedInfo"/> object from the given <see cref="ProductTypeCachedInfoDto"/>.
        /// </summary>
        /// <param name="data">The ProductTypeCachedInfoDto to use.</param>
        private void Child_Fetch(ProductTypeCachedInfoDto data)
        {
            // Value properties
