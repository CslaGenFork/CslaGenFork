...
namespace Invoices.Business
{
    ...
    /// This is a generated <see cref="ProductTypeUpdatedByRootInfo"/> business object.
    /// </summary>
    /// <remarks>
    ...
    public partial class ProductTypeUpdatedByRootInfo : ReadOnlyBase<ProductTypeUpdatedByRootInfo>
    {
        ...
        /// <summary>
        /// Loads a <see cref="ProductTypeUpdatedByRootInfo"/> object from the given <see cref="ProductTypeUpdatedByRootInfoDto"/>.
        /// </summary>
        /// <param name="data">The ProductTypeUpdatedByRootInfoDto to use.</param>
        private void Child_Fetch(ProductTypeUpdatedByRootInfoDto data)
        {
            // Value properties
