...
namespace Invoices.DataAccess.Sql
{
    ...
    public partial class SupplierEditDal : ISupplierEditDal
    {
        ...
        private List<SupplierProductItemDto> _supplierProductColl = new List<SupplierProductItemDto>();

        /// <summary>
        /// Gets the Products.
        /// </summary>
        /// <value>A list of <see cref="SupplierProductItemDto"/>.</value>
        public List<SupplierProductItemDto> SupplierProductColl
        {
            get { return _supplierProductColl; }
        }
        ...
        private void FetchChildren(SafeDataReader dr)
        {
            ...
            while (dr.Read())
            {
                _supplierProductColl.Add(FetchSupplierProductItem(dr));
            }
        }

        private SupplierProductItemDto FetchSupplierProductItem(SafeDataReader dr)
        {
