...
Namespace Invoices.Business
    ...
    Public Partial Class CustomerEdit
        ...
        ' Private Sub GetQueryGetCustomerEdit(customerId As String)
        '     getCustomerEditInlineQuery = ""
        ' End Sub

        ' Private Sub GetQueryAddCustomerEdit()
        '     addCustomerEditInlineQuery = ""
        ' End Sub

        ' Private Sub GetQueryUpdateCustomerEdit()
        '     updateCustomerEditInlineQuery = ""
        ' End Sub

        ' Private Sub GetQueryDeleteCustomerEdit(customerId As String)
