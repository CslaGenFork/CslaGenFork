...
namespace DocStore.Business
{
    ...
    /// </remarks>
    [Serializable]
    public partial class DocClassEditDyna : MyBusinessBase<DocClassEditDyna>, IHaveInterface, IHaveGenericInterface<DocClassEditDyna>
    {
        ...
        internal static DocClassEditDyna NewDocClassEditDyna()
        {
            return DataPortal.Create<DocClassEditDyna>();
        }
        ...
        internal static DocClassEditDyna GetDocClassEditDyna(SafeDataReader dr)
        {
            DocClassEditDyna obj = new DocClassEditDyna();
            obj.Fetch(dr);
            obj.MarkOld();
        ...
        internal static void DeleteDocClassEditDyna(int docClassID)
        {
            DataPortal.Delete<DocClassEditDyna>(docClassID);
        }
        ...
        internal static void NewDocClassEditDyna(EventHandler<DataPortalResult<DocClassEditDyna>> callback)
        {
            DataPortal.BeginCreate<DocClassEditDyna>(callback);
        }
        ...
        /// <param name="docClassID">The DocClassID of the DocClassEditDyna to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        internal static void DeleteDocClassEditDyna(int docClassID, EventHandler<DataPortalResult<DocClassEditDyna>> callback)
        {
            DataPortal.BeginDelete<DocClassEditDyna>(docClassID, callback);
        }
        ...
        public DocClassEditDyna()
        {
            // Use factory methods and do not use direct creation.
            Saved += OnDocClassEditDynaSaved;
        }
        ...
        private void OnDocClassEditDynaSaved(object sender, Csla.Core.SavedEventArgs e)
        {
        ...
        {
            BusinessRules.AddRule(typeof (DocClassEditDyna), new IsInRole(AuthorizationActions.CreateObject, "Admin"));
            BusinessRules.AddRule(typeof (DocClassEditDyna), new IsInRole(AuthorizationActions.GetObject, "User"));
            BusinessRules.AddRule(typeof (DocClassEditDyna), new IsInRole(AuthorizationActions.EditObject, "Admin"));
            BusinessRules.AddRule(typeof (DocClassEditDyna), new IsInRole(AuthorizationActions.DeleteObject, "Admin"));
        ...
        {
            return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.CreateObject, typeof(DocClassEditDyna));
        }
        ...
        {
            return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.GetObject, typeof(DocClassEditDyna));
        }
        ...
        {
            return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.EditObject, typeof(DocClassEditDyna));
        }
        ...
        {
            return BusinessRules.HasPermission(Csla.Rules.AuthorizationActions.DeleteObject, typeof(DocClassEditDyna));
        }
        ...
        protected override void DataPortal_Insert()
        {
            ...
            {
                using (var cmd = new SqlCommand("AddDocClassEditDyna", ctx.Connection))
                {
        ...
        protected override void DataPortal_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager(Database.DocStoreConnection, false))
            {
                using (var cmd = new SqlCommand("UpdateDocClassEditDyna", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void DataPortal_Delete(int docClassID)
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager(Database.DocStoreConnection, false))
            {
                using (var cmd = new SqlCommand("DeleteDocClassEditDyna", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
