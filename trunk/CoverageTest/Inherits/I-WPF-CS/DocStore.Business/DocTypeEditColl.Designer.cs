...
namespace DocStore.Business
{
    ...
    /// </remarks>
    [Serializable]
    public partial class DocTypeEditColl : BusinessListBase<DocTypeEditColl, DocTypeEdit>
    {
        ...
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void GetDocTypeEditColl(EventHandler<DataPortalResult<DocTypeEditColl>> callback)
        {
            DataPortal.BeginFetch<DocTypeEditColl>(callback);
        }
