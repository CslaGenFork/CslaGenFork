...
Namespace DocStore.Business
    ...
    Partial Public Class DocClassEditDynaColl
        Inherits DynamicBindingListBase(Of DocClassEditDyna)
        ...
        Public Shared Sub NewDocClassEditDynaColl(callback As EventHandler(Of DataPortalResult(Of DocClassEditDynaColl)))
            DocClassEditDynaCollGetter.NewDocClassEditDynaCollGetter(Sub(o, e)
                callback(o, New DataPortalResult(Of DocClassEditDynaColl)(e.Object.DocClassEditDynaColl, e.Error, Nothing))
            End Sub)
        End Sub
        ...
        Public Shared Sub GetDocClassEditDynaColl(ByVal callback As EventHandler(Of DataPortalResult(Of DocClassEditDynaColl)))
            DocClassEditDynaCollGetter.GetDocClassEditDynaCollGetter(Sub(o, e)
                callback(o, New DataPortalResult(Of DocClassEditDynaColl)(e.Object.DocClassEditDynaColl, e.Error, Nothing))
            End Sub)
        End Sub
