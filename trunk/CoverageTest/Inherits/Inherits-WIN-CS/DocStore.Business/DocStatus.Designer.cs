...
namespace DocStore.Business
{
    ...
    /// </remarks>
    [Serializable]
    public partial class DocStatus : BusinessBase<DocStatus>
    {
        ...
        internal static DocStatus NewDocStatus()
        {
            return DataPortal.CreateChild<DocStatus>();
        }
        ...
        internal static DocStatus GetDocStatus(SafeDataReader dr)
        {
        ...
        internal static void NewDocStatus(EventHandler<DataPortalResult<DocStatus>> callback)
        {
            DataPortal.BeginCreate<DocStatus>(callback);
        }
        ...
        private void Child_Insert()
        {
            ...
            {
                using (var cmd = new SqlCommand("AddDocStatus", ctx.Connection))
                {
        ...
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager(Database.DocStoreConnection, false))
            {
                using (var cmd = new SqlCommand("UpdateDocStatus", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void Child_DeleteSelf()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager(Database.DocStoreConnection, false))
            {
                using (var cmd = new SqlCommand("DeleteDocStatus", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@DocStatusID", ReadProperty(DocStatusIDProperty)).DbType = DbType.Int32;
