...
Namespace DocStore.Business
    ...
    Inherits ReadOnlyBase(Of DocEditUoWGetter)
        ...
        Public Shared Function GetDocEditUoWGetter(docID As Integer) As DocEditUoWGetter
            Return DataPortal.Fetch(Of DocEditUoWGetter)(docID)
        End Function
        ...
        Public Shared Sub GetDocEditUoWGetter(docID As Integer, callback As EventHandler(Of DataPortalResult(Of DocEditUoWGetter)))
            DataPortal.BeginFetch(Of DocEditUoWGetter)(docID, Sub(o, e)
