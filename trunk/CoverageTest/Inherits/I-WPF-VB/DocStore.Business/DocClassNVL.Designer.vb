...
Namespace DocStore.Business
    ...
    ''' </summary>
    <Serializable()>
    Partial Public Class DocClassNVL
    Inherits MyNameValueListBase(Of Integer, String)

        #Region " Private Fields "

        Private Shared _list As DocClassNVL
        ...
        Friend Shared Sub SetCache(lst As DocClassNVL)
            _list = lst
        End Sub
        ...
        Public Shared Function GetDocClassNVL() As DocClassNVL
            If _list Is Nothing Then
                _list = DataPortal.Fetch(Of DocClassNVL)()
            End If
        ...
        Public Shared Sub GetDocClassNVL(callback As EventHandler(Of DataPortalResult(Of DocClassNVL)))
            If _list Is Nothing Then
                DataPortal.BeginFetch(Of DocClassNVL)(Sub(o, e)
                        _list = e.Object
                        callback(o, e)
                    End Sub)
            Else
                callback(Nothing, New DataPortalResult(Of DocClassNVL)(_list, Nothing, Nothing))
            End If
        End Sub
        ...
        Protected Overloads Sub DataPortal_Fetch()
            ...
            Using cn = New SqlConnection(Database.DocStoreConnection)
                Using cmd = New SqlCommand("GetDocClassNVL", cn)
