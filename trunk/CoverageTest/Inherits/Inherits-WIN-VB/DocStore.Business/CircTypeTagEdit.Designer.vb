...
Namespace DocStore.Business
    ...
    ''' </remarks>
    <Serializable()>
    Partial Public Class CircTypeTagEdit
    Inherits BusinessBase(Of CircTypeTagEdit)
        ...
        Friend Shared Function NewCircTypeTagEdit() As CircTypeTagEdit
            Return DataPortal.CreateChild(Of CircTypeTagEdit)()
        End Function
        ...
        Friend Shared Function GetCircTypeTagEdit(dr As SafeDataReader) As CircTypeTagEdit
            Dim obj As CircTypeTagEdit = New CircTypeTagEdit()
        ...
        Friend Shared Sub NewCircTypeTagEdit(callback As EventHandler(Of DataPortalResult(Of CircTypeTagEdit)))
            DataPortal.BeginCreate(Of CircTypeTagEdit)(callback)
        End Sub
        ...
        Private Sub Child_Insert()
            ...
            Using ctx = TransactionManager(Of SqlConnection, SqlTransaction).GetManager(Database.DocStoreConnection, False)
                Using cmd = New SqlCommand("AddCircTypeTagEdit", ctx.Connection)
        ...
        Private Sub Child_Update()
            ...
            SimpleAuditTrail()
            Using ctx = TransactionManager(Of SqlConnection, SqlTransaction).GetManager(Database.DocStoreConnection, False)
                Using cmd = New SqlCommand("UpdateCircTypeTagEdit", ctx.Connection)
                    cmd.Transaction = ctx.Transaction
                    cmd.CommandType = CommandType.StoredProcedure
        ...
        Private Sub Child_DeleteSelf()
            ...
            SimpleAuditTrail()
            Using ctx = TransactionManager(Of SqlConnection, SqlTransaction).GetManager(Database.DocStoreConnection, False)
                Using cmd = New SqlCommand("DeleteCircTypeTagEdit", ctx.Connection)
                    cmd.Transaction = ctx.Transaction
                    cmd.CommandType = CommandType.StoredProcedure
                    cmd.Parameters.AddWithValue("@CircTypeID", ReadProperty(CircTypeIDProperty)).DbType = DbType.Int32
                    Dim args As New DataPortalHookArgs(cmd)
