...
Namespace DocStore.Business
    ...
    Public Partial Class DocTypeNVL
        ...
        Public Shared Sub GetDocTypeNVL(callback As EventHandler(Of DataPortalResult(Of DocTypeNVL)))
            If _list Is Nothing Then
                DataPortal.BeginFetch(Of DocTypeNVL)(Sub(o, e)
                        _list = e.Object
                        callback(o, e)
                    End Sub)
            Else
                callback(Nothing, New DataPortalResult(Of DocTypeNVL)(_list, Nothing, Nothing))
            End If
        End Sub
