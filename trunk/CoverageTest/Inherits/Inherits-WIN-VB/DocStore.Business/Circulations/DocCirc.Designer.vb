...
Namespace DocStore.Business.Circulations
    ...
    Public Partial Class DocCirc
        Inherits MyBusinessBase(Of DocCirc)
        ...
        Protected Overrides Sub Child_Create()
            ...
            LoadProperty(TagNotesCertProperty, Nothing)
        ...
        Private Sub Fetch(dr As SafeDataReader)
            ...
            LoadProperty(TagNotesCertProperty, If(dr.IsDBNull("TagNotesCert"), Nothing, dr.GetString("TagNotesCert")))
        ...
        Private Sub Child_Insert(parent As Doc)
            ...
            Using ctx = TransactionManager(Of SqlConnection, SqlTransaction).GetManager(Database.DocStoreConnection, False)
                Using cmd = New SqlCommand("AddDocCirc", ctx.Connection)
                    ...
                    cmd.Parameters.AddWithValue("@TagNotesCert", If(ReadProperty(TagNotesCertProperty) Is Nothing, DBNull.Value, ReadProperty(TagNotesCertProperty))).DbType = DbType.String
