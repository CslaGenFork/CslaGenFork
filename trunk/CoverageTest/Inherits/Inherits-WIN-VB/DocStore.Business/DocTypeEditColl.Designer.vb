...
#Else
        Inherits BusinessListBase(Of DocTypeEditColl, DocTypeEdit)
#End If
        ...
        Public Shared Sub NewDocTypeEditColl(callback As EventHandler(Of DataPortalResult(Of DocTypeEditColl)))
            DataPortal.BeginCreate(Of DocTypeEditColl)(callback)
        End Sub

        ''' <summary>
        ''' Factory method. Asynchronously loads a <see cref="DocTypeEditColl"/> collection.
        ''' </summary>
        ''' <param name="callback">The completion callback method.</param>
        Public Shared Sub GetDocTypeEditColl(ByVal callback As EventHandler(Of DataPortalResult(Of DocTypeEditColl)))
            DataPortal.BeginFetch(Of DocTypeEditColl)(callback)
        End Sub
        ...
        Private Sub Fetch(dr As SafeDataReader)
            ...
            RaiseListChangedEvents = False
            While dr.Read()
                Add(DocTypeEdit.GetDocTypeEdit(dr))
            End While
            RaiseListChangedEvents = rlce
        End Sub
