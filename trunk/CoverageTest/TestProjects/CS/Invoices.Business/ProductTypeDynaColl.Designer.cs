...
namespace Invoices.Business
{
    ...
    [Serializable]
#if WINFORMS
    public partial class ProductTypeDynaColl : DynamicBindingListBase<ProductTypeDyna>
#else
    public partial class ProductTypeDynaColl : DynamicListBase<ProductTypeDyna>
#endif
    {
        ...
        {
            foreach (var productTypeDyna in this)
            {
                if (productTypeDyna.ProductTypeId == productTypeId)
                {
                    return true;
                }
            }
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            while (dr.Read())
            {
                Add(DataPortal.Fetch<ProductTypeDyna>(dr));
            }
            RaiseListChangedEvents = rlce;
        }
