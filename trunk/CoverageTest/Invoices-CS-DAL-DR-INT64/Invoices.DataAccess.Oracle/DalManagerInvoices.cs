...
namespace Invoices.DataAccess.Oracle
{
    ...
    /// <remarks>
    /// To use this DAL:<br/>
    /// 1) name this assembly Invoices.DataAccess.Oracle<br/>
    /// 2) add the following line to the <strong>appSettings</strong>
    /// section of the application .config file: <br/>
    /// &lt;add key="Invoices.DalManagerType" value="Invoices.DataAccess.Oracle.DalManagerInvoices, Invoices.DataAccess.Oracle" /&gt;
    /// </remarks>
    public class DalManagerInvoices : IDalManagerInvoices
    {
        ...
        {
            ConnectionManager = ConnectionManager<OracleConnection>.GetManager("InvoicesDatabase");
        }
        ...
        public ConnectionManager<OracleConnection> ConnectionManager { get; private set; }
