...
namespace Invoices.DataAccess
{
    ...
    public partial interface IInvoiceEditDal
    {
        ...
        long Insert(Guid invoiceId, string invoiceNumber, string customerId, SmartDate invoiceDate, SmartDate createDate, int createUser, SmartDate changeDate, int changeUser);
        ...
        long Update(Guid invoiceId, string invoiceNumber, string customerId, SmartDate invoiceDate, SmartDate changeDate, int changeUser, long rowVersion);
