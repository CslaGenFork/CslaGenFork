...
namespace Invoices.DataAccess.Firebird
{
    ...
    /// <remarks>
    /// To use this DAL:<br/>
    /// 1) name this assembly Invoices.DataAccess.Firebird<br/>
    /// 2) add the following line to the <strong>appSettings</strong>
    /// section of the application .config file: <br/>
    /// &lt;add key="Invoices.DalManagerType" value="Invoices.DataAccess.Firebird.DalManagerInvoices, Invoices.DataAccess.Firebird" /&gt;
    /// </remarks>
    public class DalManagerInvoices : IDalManagerInvoices
    {
        ...
        {
            ConnectionManager = ConnectionManager<FbConnection>.GetManager("InvoicesDatabase");
        }
        ...
        public ConnectionManager<FbConnection> ConnectionManager { get; private set; }
