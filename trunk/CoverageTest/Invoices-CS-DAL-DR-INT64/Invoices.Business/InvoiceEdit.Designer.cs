...
namespace Invoices.Business
{
    ...
    public partial class InvoiceEdit : BusinessBase<InvoiceEdit>
    {
        ...
        /// </summary>
        [NotUndoable]
        public static readonly PropertyInfo<long> RowVersionProperty = RegisterProperty<long>(p => p.RowVersion, "Row Version");
        /// <summary>
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(RowVersionProperty, dr.GetInt64("RowVersion"));
        ...
        protected override void DataPortal_Insert()
        {
            ...
            using (var dalManager = DalFactoryInvoices.GetManager())
            {
                ...
                {
                    LoadProperty(RowVersionProperty, dal.Insert(
                        InvoiceId,
                        InvoiceNumber,
                        CustomerId,
