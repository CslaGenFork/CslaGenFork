...
namespace Invoices.DataAccess.MySql
{
    ...
    /// <remarks>
    /// To use this DAL:<br/>
    /// 1) name this assembly Invoices.DataAccess.MySql<br/>
    /// 2) add the following line to the <strong>appSettings</strong>
    /// section of the application .config file: <br/>
    /// &lt;add key="Invoices.DalManagerType" value="Invoices.DataAccess.MySql.DalManagerInvoices, Invoices.DataAccess.MySql" /&gt;
    /// </remarks>
    public class DalManagerInvoices : IDalManagerInvoices
    {
        ...
        {
            ConnectionManager = ConnectionManager<MySqlConnection>.GetManager("InvoicesDatabase");
        }
