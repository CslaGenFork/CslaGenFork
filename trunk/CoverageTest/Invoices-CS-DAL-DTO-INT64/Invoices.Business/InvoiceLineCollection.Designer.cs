...
namespace Invoices.Business
{
...
#endif
    {
        ...
        /// <summary>
        /// Loads all <see cref="InvoiceLineCollection"/> collection items from the given list of InvoiceLineItemDto.
        /// </summary>
        /// <param name="data">The list of <see cref="InvoiceLineItemDto"/>.</param>
        private void Child_Fetch(List<InvoiceLineItemDto> data)
        {
            var rlce = RaiseListChangedEvents;
            RaiseListChangedEvents = false;
            ...
            {
                Add(DataPortal.FetchChild<InvoiceLineItem>(dto));
            }
            OnFetchPost(args);
            RaiseListChangedEvents = rlce;
        }
