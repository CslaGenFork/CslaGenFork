    ...
    public partial class SupplierEditDal : ISupplierEditDal
    {
        ...
        public SupplierEditDto Insert(SupplierEditDto supplierEdit)
        {
            using (var ctx = ConnectionManager<OracleConnection>.GetManager("Invoices"))
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@SupplierId", supplierEdit.SupplierId).DbType = DbType.Int32;
                    cmd.Parameters.Add("@Name", supplierEdit.Name).DbType = DbType.String;
                    cmd.Parameters.Add("@AddressLine1", supplierEdit.AddressLine1 == null ? (object)DBNull.Value : supplierEdit.AddressLine1).DbType = DbType.String;
                    cmd.Parameters.Add("@AddressLine2", supplierEdit.AddressLine2 == null ? (object)DBNull.Value : supplierEdit.AddressLine2).DbType = DbType.String;
                    cmd.Parameters.Add("@ZipCode", supplierEdit.ZipCode == null ? (object)DBNull.Value : supplierEdit.ZipCode).DbType = DbType.String;
                    cmd.Parameters.Add("@State", supplierEdit.State == null ? (object)DBNull.Value : supplierEdit.State).DbType = DbType.String;
                    cmd.Parameters.Add("@Country", supplierEdit.Country == null ? (object)DBNull.Value : supplierEdit.Country.Value).DbType = DbType.Byte;
                    cmd.ExecuteNonQuery();
                }
            }
            return supplierEdit;
