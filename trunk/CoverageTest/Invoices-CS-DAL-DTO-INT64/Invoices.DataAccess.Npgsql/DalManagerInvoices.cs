...
namespace Invoices.DataAccess.Npgsql
{
    ...
    /// <remarks>
    /// To use this DAL:<br/>
    /// 1) name this assembly Invoices.DataAccess.Npgsql<br/>
    /// 2) add the following line to the <strong>appSettings</strong>
    /// section of the application .config file: <br/>
    /// &lt;add key="Invoices.DalManagerType" value="Invoices.DataAccess.Npgsql.DalManagerInvoices, Invoices.DataAccess.Npgsql" /&gt;
    /// </remarks>
    public class DalManagerInvoices : IDalManagerInvoices
    {
        ...
        {
            ConnectionManager = ConnectionManager<NpgsqlConnection>.GetManager("InvoicesDatabase");
        }
        ...
        public ConnectionManager<NpgsqlConnection> ConnectionManager { get; private set; }
